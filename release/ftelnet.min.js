...
var fTelnet = function () {
    ...
    a.OnAnsiESC6n = function () { this._Connection.writeString(Ansi.CursorPosition()) }; a.OnAnsiESC255n = function () { this._Connection.writeString(Ansi.CursorPosition(Crt.WindCols, Crt.WindRows)) }; a.OnAnsiESCQ = function (b) { Crt.SetFont(b) }; a.OnConnectionClose = function () { this._StatusBar.innerHTML = "Disconnected from " + this._Hostname + ":" + this._Port }; a.OnConnectionConnect = function () {
        ...
        b - 10 + "px"); null != this._ButtonBar && (this._ButtonBar.style.width = b - 10 + "px"); null != this._ScrollbackBar && (this._ScrollbackBar.style.width = b - 10 + "px"); null != this._StatusBar && (this._StatusBar.style.width = b - 10 + "px"); if (null !== document.getElementById("fTelnetScript") && null != document.getElementById("fTelnetKeyboardCss")) for (var c = document.getElementById("fTelnetScript").src.replace("/ftelnet.min.js", "/keyboard/keyboard-{size}.min.css"), c = c.replace("/ftelnet.debug.js", "/keyboard/keyboard-{size}.min.css"), a =
        [960, 800, 720, 640, 560, 480], e = 0; e < a.length; e++) if (b >= a[e] || e === a.length - 1) { document.getElementById("fTelnetKeyboardCss").href = c.replace("{size}", a[e].toString(10)); break }
        ...
        if (null !== this._Connection && this._Connection.connected) {
            document.hasFocus() && !this._HasFocus ? (this._HasFocus = !0, this._FocusWarningBar.style.display = "none") : !document.hasFocus() && this._HasFocus && (this._HasFocus = !1, this._FocusWarningBar.style.display =
            "block"); var b = (new Date).getTime() - this._LastTimer; 1 > b && (b = 1); b = Math.floor(this._BitsPerSecond / 8 / (1E3 / b)); 1 > b && (b = 1); b = this._Connection.readString(b); for (0 < b.length && Ansi.Write(b) ; Crt.KeyPressed() ;) b = Crt.ReadKey(), null !== b && 0 < b.keyString.length && ("\r\n" === b.keyString ? this._Connection.writeString(this._Enter) : this._Connection.writeString(b.keyString))
        } this._LastTimer = (new Date).getTime()
    }; a.OnUploadComplete = function () { var b = this; this._Timer = setInterval(function () { b.OnTimer() }, 50) }; a.OnUploadFileSelected =
    function () { var b = this; if (null !== this._Connection && this._Connection.connected) { var c = document.getElementById("fTelnetUpload"); this._YModemSend = new YModemSend(this._Connection); clearInterval(this._Timer); this._YModemSend.ontransfercomplete.on(function () { b.OnUploadComplete() }); for (var a = 0; a < c.files.length; a++) this.UploadFile(c.files[a], c.files.length) } }; Object.defineProperty(a, "Port", { get: function () { return this._Port }, set: function (b) { this._Port = b }, enumerable: !0, configurable: !0 }); Object.defineProperty(a,
    "ProxyHostname", { get: function () { return this._ProxyHostname }, set: function (b) { this._ProxyHostname = b }, enumerable: !0, configurable: !0 }); Object.defineProperty(a, "ProxyPort", { get: function () { return this._ProxyPort }, set: function (b) { this._ProxyPort = b }, enumerable: !0, configurable: !0 }); Object.defineProperty(a, "ProxyPortSecure", { get: function () { return this._ProxyPortSecure }, set: function (b) { this._ProxyPortSecure = b }, enumerable: !0, configurable: !0 }); Object.defineProperty(a, "ScreenColumns", {
        get: function () { return this._ScreenColumns },
        set: function (b) { this._ScreenColumns = b }, enumerable: !0, configurable: !0
    }); Object.defineProperty(a, "ScreenRows", { get: function () { return this._ScreenRows }, set: function (b) { this._ScreenRows = b }, enumerable: !0, configurable: !0 }); Object.defineProperty(a, "SplashScreen", { get: function () { return this._SplashScreen }, set: function (b) { this._SplashScreen = b }, enumerable: !0, configurable: !0 }); Object.defineProperty(a, "StatusBarVisible", {
        get: function () { return this._StatusBarVisible }, set: function (b) {
            this._StatusBarVisible = b; null !=
            this._StatusBar && (this._StatusBar.style.display = b ? "block" : "none")
        }, enumerable: !0, configurable: !0
    }); a.Upload = function () { null !== this._Connection && this._Connection.connected && document.getElementById("fTelnetUpload").click() }; a.UploadFile = function (b, c) { var a = this, e = new FileReader; e.onload = function () { for (var f = new FileRecord(b.name, b.size), g = new Uint8Array(e.result), h = 0; h < g.length; h++) f.data.writeByte(g[h]); f.data.position = 0; a._YModemSend.Upload(f, c) }; e.readAsArrayBuffer(b) }; Object.defineProperty(a, "VirtualKeyboardVisible",
    { get: function () { return this._VirtualKeyboardVisible }, set: function (b) { this._VirtualKeyboardVisible = b; VirtualKeyboard.Visible = b }, enumerable: !0, configurable: !0 }); a._ButtonBar = null; a._Connection = null; a._Container = null; a._FocusWarningBar = null; a._HasFocus = !0; a._InitMessageBar = null; a._LastTimer = 0; a._ScrollbackBar = null; a._StatusBar = null; a._Timer = null; a._YModemReceive = null; a._YModemSend = null; a._BareLFtoCRLF = !1; a._BitsPerSecond = 57600; a._Blink = !0; a._ButtonBarVisible = !0; a._ConnectionType = "telnet"; a._Enter = "\r";
    a._Font = "CP437"; a._Hostname = "bbs.ftelnet.ca"; a._LocalEcho = !1; a._Port = 1123; a._ProxyHostname = ""; a._ProxyPort = 1123; a._ProxyPortSecure = 11235; a._ScreenColumns = 80; a._ScreenRows = 25; a._SplashScreen = "";
...
var Crt = function () {
    ...
    Object.defineProperty(a, "ScreenCols", { get: function () { return this._ScreenSize.x }, enumerable: !0, configurable: !0 }); Object.defineProperty(a, "ScreenRows", { get: function () { return this._ScreenSize.y }, enumerable: !0, configurable: !0 }); a.ScrollDownCustom = function (a, c, d, e, f, g, h) {
        ...
        l = (c - 1 + f) * this._Font.Height, this._CanvasContext.putImageData(m, k, l)); this._CanvasContext.fillStyle = "#" + CrtFont.ANSI_COLOURS[(g.Attr & 240) >> 4].toString(16); k = (a - 1) * this._Font.Width; l = (c - 1) * this._Font.Height; m = (d - a + 1) * this._Font.Width; p = f * this._Font.Height; this._CanvasContext.fillRect(k, l, m, p); if (h) {
            k = h = 0; for (k = e; k > f; k--) for (h = a; h <= d; h++) this._Buffer[k][h].Ch = this._Buffer[k - f][h].Ch, this._Buffer[k][h].Attr = this._Buffer[k - f][h].Attr, this._Buffer[k][h].Blink = this._Buffer[k - f][h].Blink, this._Buffer[k][h].Underline =
            this._Buffer[k - f][h].Underline, this._Buffer[k][h].Reverse = this._Buffer[k - f][h].Reverse; for (k = c; k <= f; k++) for (h = a; h <= d; h++) this._Buffer[k][h].Ch = g.Ch, this._Buffer[k][h].Attr = g.Attr, this._Buffer[k][h].Blink = g.Blink, this._Buffer[k][h].Underline = g.Underline, this._Buffer[k][h].Reverse = g.Reverse
        }
        ...
        this.ScrollDownCustom(this.WindMinX + 1, this.WindMinY + 1, this.WindMaxX +
        1, this.WindMaxY + 1, a, this._CharInfo)
        ...
        "undefined" === typeof h && (h = !0); var k = e - c + 1; f > k && (f = k); if (!this._InScrollBack || this._InScrollBack && !h) {
            var k = (a - 1) * this._Font.Width, l = (c - 1 + f) * this._Font.Height, m = (d - a + 1) * this._Font.Width, p = (e - c + 1 - f) * this._Font.Height; 0 < p && (m = this._CanvasContext.getImageData(k, l, m, p), k = (a - 1) * this._Font.Width, l = (c - 1) * this._Font.Height, this._CanvasContext.putImageData(m, k, l)); this._CanvasContext.fillStyle = "#" + CrtFont.ANSI_COLOURS[(g.Attr & 240) >>
            4].toString(16); k = (a - 1) * this._Font.Width; l = (e - f) * this._Font.Height; m = (d - a + 1) * this._Font.Width; p = f * this._Font.Height; this._CanvasContext.fillRect(k, l, m, p)
        } if (h) {
            for (l = 0; l < f; l++) { h = []; for (k = a; k <= d; k++) h.push(new CharInfo(this._Buffer[l + c][k].Ch, this._Buffer[l + c][k].Attr, this._Buffer[l + c][k].Blink, this._Buffer[l + c][k].Underline, this._Buffer[l + c][k].Reverse)); this._ScrollBack.push(h) } for (h = this._ScrollBack.length; h > this._ScrollBackSize - 2;) this._ScrollBack.shift(), --h; for (l = c; l <= e - f; l++) for (k = a; k <= d; k++) this._Buffer[l][k].Ch =
            this._Buffer[l + f][k].Ch, this._Buffer[l][k].Attr = this._Buffer[l + f][k].Attr, this._Buffer[l][k].Blink = this._Buffer[l + f][k].Blink, this._Buffer[l][k].Underline = this._Buffer[l + f][k].Underline, this._Buffer[l][k].Reverse = this._Buffer[l + f][k].Reverse; for (l = e; l > e - f; l--) for (k = a; k <= d; k++) this._Buffer[l][k].Ch = g.Ch, this._Buffer[l][k].Attr = g.Attr, this._Buffer[l][k].Blink = g.Blink, this._Buffer[l][k].Underline = g.Underline, this._Buffer[l][k].Reverse = g.Reverse
        }
    }; a.ScrollUpScreen = function (a) {
        this.ScrollUpCustom(1, 1,
        this._ScreenSize.x, this._ScreenSize.y, a, this._CharInfo)
    }; a.ScrollUpWindow = function (a) { this.ScrollUpCustom(this.WindMinX + 1, this.WindMinY + 1, this.WindMaxX + 1, this.WindMaxY + 1, a, this._CharInfo) }; a.SetBlink = function (a) { this._CharInfo.Blink = a }; a.SetBlinkRate = function (a) { this._Cursor.BlinkRate = a }; a.SetCharInfo = function (a) { this._CharInfo = new CharInfo(a.Ch, a.Attr, a.Blink, a.Underline, a.Reverse) }; a.SetFont = function (a) {
        return this._Font.Load(a, Math.floor(this._Container.clientWidth / this._ScreenSize.x), Math.floor(window.innerHeight /
        this._ScreenSize.y))
    }; a.SetScreenSize = function (a, c) {
        if (!this._InScrollBack && (a !== this._ScreenSize.x || c !== this._ScreenSize.y)) {
            var d = 0, e = 0, f; if (null !== this._Buffer) for (f = [], e = 1; e <= this._ScreenSize.y; e++) for (f[e] = [], d = 1; d <= this._ScreenSize.x; d++) f[e][d] = new CharInfo(this._Buffer[e][d].Ch, this._Buffer[e][d].Attr, this._Buffer[e][d].Blink, this._Buffer[e][d].Underline, this._Buffer[e][d].Reverse); var g = new Point(this._ScreenSize.x, this._ScreenSize.y); this._ScreenSize.x = a; this._ScreenSize.y = c; this._WindMin =
            0; this._WindMax = this._ScreenSize.x - 1 | this._ScreenSize.y - 1 << 8; this.InitBuffers(!1); if (null !== f) for (e = 1; e <= Math.min(this._ScreenSize.y, g.y) ; e++) for (d = 1; d <= Math.min(this._ScreenSize.x, g.x) ; d++) this.FastWrite(f[e][d].Ch, d, e, f[e][d]); this.onscreensizechange.trigger()
        }
    }; a.ShowCursor = function () { this._Cursor.Visible = !0 }; Object.defineProperty(a, "TextAttr", { get: function () { return this._CharInfo.Attr }, set: function (a) { this._CharInfo.Attr = a }, enumerable: !0, configurable: !0 }); a.TextBackground = function (a) {
        this.TextAttr =
        this.TextAttr & 15 | (a & 15) << 4
    }; a.TextColor = function (a) { this.TextAttr = this.TextAttr & 240 | a & 15 }; a.WhereX = function () { return this._Cursor.Position.x }; a.WhereXA = function () { return this.WhereX() + this.WindMinX }; a.WhereY = function () { return this._Cursor.Position.y }; a.WhereYA = function () { return this.WhereY() + this.WindMinY }; Object.defineProperty(a, "WindCols", { get: function () { return this.WindMaxX - this.WindMinX + 1 }, enumerable: !0, configurable: !0 }); Object.defineProperty(a, "WindMax", {
        get: function () { return this._WindMax },
        enumerable: !0, configurable: !0
    }); Object.defineProperty(a, "WindMaxX", { get: function () { return this.WindMax & 255 }, enumerable: !0, configurable: !0 }); Object.defineProperty(a, "WindMaxY", { get: function () { return (this.WindMax & 65280) >> 8 }, enumerable: !0, configurable: !0 }); Object.defineProperty(a, "WindMin", { get: function () { return this._WindMin }, enumerable: !0, configurable: !0 }); Object.defineProperty(a, "WindMinX", { get: function () { return this.WindMin & 255 }, enumerable: !0, configurable: !0 }); Object.defineProperty(a, "WindMinY",
    { get: function () { return (this.WindMin & 65280) >> 8 }, enumerable: !0, configurable: !0 }); a.Window = function (a, c, d, e) { 1 <= a && 1 <= c && a <= d && c <= e && d <= this._ScreenSize.x && e <= this._ScreenSize.y && (this._WindMin = a - 1 + (c - 1 << 8), this._WindMax = d - 1 + (e - 1 << 8), this._Cursor.WindowOffset = new Point(a - 1, c - 1), this.GotoXY(1, 1)) }; Object.defineProperty(a, "WindRows", { get: function () { return this.WindMaxY - this.WindMinY + 1 }, enumerable: !0, configurable: !0 }); a.Write = function (a) { this._Atari ? this.WriteATASCII(a) : this._C64 ? this.WritePETSCII(a) : this.WriteASCII(a) };
    a.WriteASCII = function (a) {
        "undefined" === typeof a && (a = ""); for (var c = this.WhereX(), d = this.WhereY(), e = "", f = 0; f < a.length; f++) {
            var g = !1; 0 === a.charCodeAt(f) ? f += 0 : 7 === a.charCodeAt(f) ? this.Beep() : 8 === a.charCodeAt(f) ? (this.FastWrite(e, this.WhereXA(), this.WhereYA(), this._CharInfo), c += e.length, 1 < c && --c, g = !0, e = "") : 9 === a.charCodeAt(f) ? (this.FastWrite(e, this.WhereXA(), this.WhereYA(), this._CharInfo), c += e.length, e = "", c === this.WindCols ? (c = 1, d += 1) : (c += 8 - c % 8, c = Math.min(c, this.WindCols)), g = !0) : 10 === a.charCodeAt(f) ? (this.FastWrite(e,
            this.WhereXA(), this.WhereYA(), this._CharInfo), c = this._BareLFtoCRLF && 13 !== this._LastChar ? 1 : c + e.length, d += 1, g = !0, e = "") : 12 === a.charCodeAt(f) ? (this.ClrScr(), d = c = 1, e = "") : 13 === a.charCodeAt(f) ? (this.FastWrite(e, this.WhereXA(), this.WhereYA(), this._CharInfo), c = 1, g = !0, e = "") : 0 !== a.charCodeAt(f) && (e += String.fromCharCode(a.charCodeAt(f) & 255), c + e.length > this.WindCols && (this.FastWrite(e, this.WhereXA(), this.WhereYA(), this._CharInfo), e = "", c = 1, d += 1, g = !0)); this._LastChar = a.charCodeAt(f); d > this.WindRows && (d = this.WindRows,
            this.ScrollUpWindow(1), g = !0); g && this.GotoXY(c, d)
        } 0 < e.length && (this.FastWrite(e, this.WhereXA(), this.WhereYA(), this._CharInfo), c += e.length, this.GotoXY(c, d))
    }; a.WriteATASCII = function (a) {
        "undefined" === typeof a && (a = ""); for (var c = this.WhereX(), d = this.WhereY(), e = "", f = 0; f < a.length; f++) {
            var g = !1; 0 === a.charCodeAt(f) && (f += 0); 27 !== a.charCodeAt(f) || this._ATASCIIEscaped ? 28 !== a.charCodeAt(f) || this._ATASCIIEscaped ? 29 !== a.charCodeAt(f) || this._ATASCIIEscaped ? 30 !== a.charCodeAt(f) || this._ATASCIIEscaped ? 31 !== a.charCodeAt(f) ||
            this._ATASCIIEscaped ? 125 !== a.charCodeAt(f) || this._ATASCIIEscaped ? 126 !== a.charCodeAt(f) || this._ATASCIIEscaped ? 127 !== a.charCodeAt(f) || this._ATASCIIEscaped ? 155 !== a.charCodeAt(f) || this._ATASCIIEscaped ? 156 !== a.charCodeAt(f) || this._ATASCIIEscaped ? 157 !== a.charCodeAt(f) || this._ATASCIIEscaped ? 253 !== a.charCodeAt(f) || this._ATASCIIEscaped ? 254 !== a.charCodeAt(f) || this._ATASCIIEscaped ? 255 !== a.charCodeAt(f) || this._ATASCIIEscaped ? (e = 0 === a.charCodeAt(f) && 13 === this._LastChar ? e + "" : e + String.fromCharCode(a.charCodeAt(f) &
            255), this._ATASCIIEscaped = !1, this._LastChar = a.charCodeAt(f), c + e.length > this.WindCols && (this.FastWrite(e, this.WhereXA(), this.WhereYA(), this._CharInfo), e = "", c = 1, d += 1, g = !0)) : (this.FastWrite(e, this.WhereXA(), this.WhereYA(), this._CharInfo), c += e.length, e = "", this.GotoXY(c, d), this.InsChar()) : (this.FastWrite(e, this.WhereXA(), this.WhereYA(), this._CharInfo), c += e.length, e = "", this.GotoXY(c, d), this.DelChar()) : this.Beep() : (this.FastWrite(e, this.WhereXA(), this.WhereYA(), this._CharInfo), c = 1, e = "", this.GotoXY(c, d),
            this.InsLine()) : (this.FastWrite(e, this.WhereXA(), this.WhereYA(), this._CharInfo), c = 1, e = "", this.GotoXY(c, d), this.DelLine()) : (this.FastWrite(e, this.WhereXA(), this.WhereYA(), this._CharInfo), c = 1, d += 1, g = !0, e = "") : (this.FastWrite(e, this.WhereXA(), this.WhereYA(), this._CharInfo), c += e.length, e = "", c === this.WindCols ? (c = 1, d += 1) : c += 8 - c % 8, g = !0) : (this.FastWrite(e, this.WhereXA(), this.WhereYA(), this._CharInfo), c += e.length, e = "", g = !0, 1 < c && (--c, this.FastWrite(" ", c, this.WhereYA(), this._CharInfo))) : (this.ClrScr(), d = c = 1,
            e = "") : (this.FastWrite(e, this.WhereXA(), this.WhereYA(), this._CharInfo), c += e.length, c = c < this.WindCols ? c + 1 : 1, g = !0, e = "") : (this.FastWrite(e, this.WhereXA(), this.WhereYA(), this._CharInfo), c += e.length, c = 1 < c ? c - 1 : this.WindCols, g = !0, e = "") : (this.FastWrite(e, this.WhereXA(), this.WhereYA(), this._CharInfo), c += e.length, d = d < this.WindRows ? d + 1 : 1, g = !0, e = "") : (this.FastWrite(e, this.WhereXA(), this.WhereYA(), this._CharInfo), c += e.length, d = 1 < d ? d - 1 : this.WindRows, g = !0, e = "") : this._ATASCIIEscaped = !0; d > this.WindRows && (d = this.WindRows,
            this.ScrollUpWindow(1), g = !0); g && this.GotoXY(c, d)
        } 0 < e.length && (this.FastWrite(e, this.WhereXA(), this.WhereYA(), this._CharInfo), c += e.length, this.GotoXY(c, d))
    }; a.WritePETSCII = function (a) {
        "undefined" === typeof a && (a = ""); for (var c = this.WhereX(), d = this.WhereY(), e = "", f = 0; f < a.length; f++) {
            var g = !1; "" !== e && -1 !== this._FlushBeforeWritePETSCII.indexOf(a.charCodeAt(f)) && (this.FastWrite(e, this.WhereXA(), this.WhereYA(), this._CharInfo), c += e.length, g = !0, e = ""); if (0 === a.charCodeAt(f)) f += 0; else if (5 === a.charCodeAt(f)) this.TextColor(this.PETSCII_WHITE);
            else if (7 === a.charCodeAt(f)) this.Beep(); else if (8 === a.charCodeAt(f)) console.log("PETSCII 0x08"); else if (9 === a.charCodeAt(f)) console.log("PETSCII 0x09"); else if (10 === a.charCodeAt(f)) f += 0; else if (13 === a.charCodeAt(f) || 141 === a.charCodeAt(f)) c = 1, d += 1, this._CharInfo.Reverse = !1, g = !0; else if (14 === a.charCodeAt(f)) this.SetFont("C64-Lower"); else if (17 === a.charCodeAt(f)) d += 1, g = !0; else if (18 === a.charCodeAt(f)) this._CharInfo.Reverse = !0; else if (19 === a.charCodeAt(f)) d = c = 1, g = !0; else if (20 === a.charCodeAt(f)) {
                if (1 <
                c || 1 < d) 1 === c ? (c = this.WindCols, --d) : --c, this.GotoXY(c, d), this.DelChar(1)
            } else if (28 === a.charCodeAt(f)) this.TextColor(this.PETSCII_RED); else if (29 === a.charCodeAt(f)) c === this.WindCols ? (c = 1, d += 1) : c += 1, g = !0; else if (30 === a.charCodeAt(f)) this.TextColor(this.PETSCII_GREEN); else if (31 === a.charCodeAt(f)) this.TextColor(this.PETSCII_BLUE); else if (129 === a.charCodeAt(f)) this.TextColor(this.PETSCII_ORANGE); else if (142 === a.charCodeAt(f)) this.SetFont("C64-Upper"); else if (144 === a.charCodeAt(f)) this.TextColor(this.PETSCII_BLACK);
            else if (145 === a.charCodeAt(f)) 1 < d && (--d, g = !0); else if (146 === a.charCodeAt(f)) this._CharInfo.Reverse = !1; else if (147 === a.charCodeAt(f)) this.ClrScr(), d = c = 1; else if (148 === a.charCodeAt(f)) this.GotoXY(c, d), this.InsChar(1); else if (149 === a.charCodeAt(f)) this.TextColor(this.PETSCII_BROWN); else if (150 === a.charCodeAt(f)) this.TextColor(this.PETSCII_LIGHTRED); else if (151 === a.charCodeAt(f)) this.TextColor(this.PETSCII_DARKGRAY); else if (152 === a.charCodeAt(f)) this.TextColor(this.PETSCII_GRAY); else if (153 === a.charCodeAt(f)) this.TextColor(this.PETSCII_LIGHTGREEN);
...
var Cursor = function () {
    ...
    function a() {
        ...
        new Point(c.x, c.y); 0 === b.indexOf("Atari") && (a.ANSI_COLOURS[7] = 6534887, a.ANSI_COLOURS[0] = 20868); this._Png = new Image; this._Png.crossOrigin = "Anonymous"; this._Png.onload = function () { e.OnPngLoad() }; this._Png.onerror = function () { e.OnPngError() }; this._Png.src = CrtFonts.GetLocalUrl(b, this._NewSize.x, this._NewSize.y); return !0
        ...
        var a = this; this._Png = new Image; this._Png.crossOrigin =
        "Anonymous"; this._Png.onload = function () { a.OnPngLoad() }; this._Png.onerror = function () { alert("fTelnet Error: Unable to load requested font") }; this._Png.src = CrtFonts.GetRemoteUrl(this._NewName, this._NewSize.x, this._NewSize.y)
    }; a.prototype.OnPngLoad = function () { this._Name = this._NewName; this._Size = this._NewSize; this._Canvas.width = this._Png.width; this._Canvas.height = this._Png.height; this._CanvasContext.drawImage(this._Png, 0, 0); this._CharMap = []; --this._Loading; this.onchange.trigger() }; Object.defineProperty(a.prototype,
    "Size", { get: function () { return this._Size }, enumerable: !0, configurable: !0 }); Object.defineProperty(a.prototype, "Width", { get: function () { return this._Size.x }, enumerable: !0, configurable: !0 }); a.ANSI_COLOURS = [0, 168, 43008, 43176, 11010048, 11010216, 11031552, 11053224, 5526612, 5526780, 5569620, 5569788, 16536660, 16536828, 16579668, 16579836]; a.PETSCII_COLOURS = [0, 16645884, 12458532, 3204806, 11803362, 2085406, 2169774, 14677514, 12075268, 6959876, 16665175, 4343104, 7369839, 5897817, 6247422, 10790818]; return a
}(), CrtFonts = function () {
    function a() { }
    a.GetBestFit = function (a, c, d) { if ("undefined" === typeof this._Fonts[a]) return null; if (1 === this._Fonts[a].length) return this._Fonts[a][0]; for (var e = 0; e < this._Fonts[a].length; e++) if (this._Fonts[a][e].x <= c && this._Fonts[a][e].y <= d) return this._Fonts[a][e]; return this._Fonts[a][this._Fonts[a].length - 1] }; a.GetLocalUrl = function (a, c, d) {
        if (null === document.getElementById("fTelnetScript")) return this.GetRemoteUrl(a, c, d); var e = document.getElementById("fTelnetScript").src.replace("/ftelnet.min.js", "/fonts/" + a + "_" +
        c.toString(10) + "x" + d.toString(10) + ".png"); return e = e.replace("/ftelnet.debug.js", "/fonts/" + a + "_" + c.toString(10) + "x" + d.toString(10) + ".png")
...
})(TelnetOption || (TelnetOption = {})); window.WebSocket = window.WebSocket || window.MozWebSocket;
