...
this._Crt.Write(Buffer);}};Ansi.prototype.WriteLn=function(text){this.Write(text+'\r\n');};return Ansi;}());var fTelnet=(function(){function fTelnet(container){var _this=this;this.ondata=new TypedEvent();this._HasFocus=true;this._LastTimer=0;this._UseModernScrollback=false;this._BareLFtoCRLF=false;this._BitsPerSecond=57600;this._Blink=true;this._ConnectionType='telnet';this._Emulation='ansi-bbs';this._Enter='\r';this._Font='CP437';this._ForceWss=false;this._Hostname='bbs.ftelnet.ca';this._LocalEcho=false;this._Port=1123;this._ProxyHostname='';this._ProxyPort=1123;this._ProxyPortSecure=11235;this._RLoginClientUsername='';this._RLoginServerUsername='';this._RLoginTerminalType='';this._ScreenColumns=80;this._ScreenRows=25;this._SplashScreen='';this._StatusBarVisible=true;this._VirtualKeyboardVisible=DetectMobileBrowser.IsMobile;if(typeof container==='string'){var ActualContainer=document.getElementById(container);if(ActualContainer===null){alert('fTelnet Error: fTelnet constructor was passed an unknown id');}
else{container=ActualContainer;}}
if(typeof container==='undefined'){alert('fTelnet Error: fTelnet constructor was passed an undefined element');}
...
this._Timer=setInterval(function(){_this.OnTimer();},250);var fTelnetUpload=document.createElement('input');fTelnetUpload.type='file';fTelnetUpload.className='fTelnetUpload';fTelnetUpload.onchange=function(){_this.OnUploadFileSelected();};fTelnetUpload.style.display='none';this._fTelnetContainer.appendChild(fTelnetUpload);}
