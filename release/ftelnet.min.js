...
return this._IsMobile;},enumerable:true,configurable:true});Object.defineProperty(DetectMobileBrowser,"SupportsModernScrollback",{get:function(){return!DetectMobileBrowser.IsMobile;},enumerable:true,configurable:true});return DetectMobileBrowser;}());var fTelnet=(function(){function fTelnet(){}
fTelnet.Init=function(){try{this._Client=new fTelnetClient('fTelnetContainer');if(typeof this._BareLFtoCRLF!=='undefined'){this._Client.BareLFtoCRLF=this._BareLFtoCRLF;}
...
return true;}
catch(e){return false;}};Object.defineProperty(fTelnet,"BareLFtoCRLF",{get:function(){if(typeof this._Client==='undefined'){return this._BareLFtoCRLF;}
else{return this._Client.BareLFtoCRLF;}},set:function(value){if(typeof this._Client==='undefined'){this._BareLFtoCRLF=value;}
else{this._Client.BareLFtoCRLF=value;}},enumerable:true,configurable:true});Object.defineProperty(fTelnet,"BitsPerSecond",{get:function(){if(typeof this._Client==='undefined'){return this._BitsPerSecond;}
else{return this._Client.BitsPerSecond;}},set:function(value){if(typeof this._Client==='undefined'){this._BitsPerSecond=value;}
else{this._Client.BitsPerSecond=value;}},enumerable:true,configurable:true});Object.defineProperty(fTelnet,"Blink",{get:function(){if(typeof this._Client==='undefined'){return this._Blink;}
else{return this._Client.Blink;}},set:function(value){this._Blink=value;},enumerable:true,configurable:true});fTelnet.Connect=function(){if(typeof this._Client!=='undefined'){this._Client.Connect();}};Object.defineProperty(fTelnet,"ConnectionType",{get:function(){if(typeof this._Client==='undefined'){return this._ConnectionType;}
else{return this._Client.ConnectionType;}},set:function(value){if(typeof this._Client==='undefined'){this._ConnectionType=value;}
else{this._Client.ConnectionType=value;}},enumerable:true,configurable:true});Object.defineProperty(fTelnet,"Emulation",{get:function(){if(typeof this._Client==='undefined'){return this._Emulation;}
else{return this._Client.Emulation;}},set:function(value){if(typeof this._Client==='undefined'){this._Emulation=value;}
else{this._Client.Emulation=value;}},enumerable:true,configurable:true});Object.defineProperty(fTelnet,"Enter",{get:function(){if(typeof this._Client==='undefined'){return this._Enter;}
else{return this._Client.Enter;}},set:function(value){if(typeof this._Client==='undefined'){this._Enter=value;}
else{this._Client.Enter=value;}},enumerable:true,configurable:true});Object.defineProperty(fTelnet,"Font",{get:function(){if(typeof this._Client==='undefined'){return this._Font;}
else{return this._Client.Font;}},set:function(value){if(typeof this._Client==='undefined'){this._Font=value;}
else{this._Client.Font=value;}},enumerable:true,configurable:true});Object.defineProperty(fTelnet,"ForceWss",{get:function(){if(typeof this._Client==='undefined'){return this._ForceWss;}
else{return this._Client.ForceWss;}},set:function(value){if(typeof this._Client==='undefined'){this._ForceWss=value;}
else{this._Client.ForceWss=value;}},enumerable:true,configurable:true});Object.defineProperty(fTelnet,"Hostname",{get:function(){if(typeof this._Client==='undefined'){return this._Hostname;}
else{return this._Client.Hostname;}},set:function(value){if(typeof this._Client==='undefined'){this._Hostname=value;}
else{this._Client.Hostname=value;}},enumerable:true,configurable:true});Object.defineProperty(fTelnet,"LocalEcho",{get:function(){if(typeof this._Client==='undefined'){return this._LocalEcho;}
else{return this._Client.LocalEcho;}},set:function(value){if(typeof this._Client==='undefined'){this._LocalEcho=value;}
else{this._Client.LocalEcho=value;}},enumerable:true,configurable:true});Object.defineProperty(fTelnet,"Port",{get:function(){if(typeof this._Client==='undefined'){return this._Port;}
else{return this._Client.Port;}},set:function(value){if(typeof this._Client==='undefined'){this._Port=value;}
else{this._Client.Port=value;}},enumerable:true,configurable:true});Object.defineProperty(fTelnet,"ProxyHostname",{get:function(){if(typeof this._Client==='undefined'){return this._ProxyHostname;}
else{return this._Client.ProxyHostname;}},set:function(value){if(typeof this._Client==='undefined'){this._ProxyHostname=value;}
else{this._Client.ProxyHostname=value;}},enumerable:true,configurable:true});Object.defineProperty(fTelnet,"ProxyPort",{get:function(){if(typeof this._Client==='undefined'){return this._ProxyPort;}
else{return this._Client.ProxyPort;}},set:function(value){if(typeof this._Client==='undefined'){this._ProxyPort=value;}
else{this._Client.ProxyPort=value;}},enumerable:true,configurable:true});Object.defineProperty(fTelnet,"ProxyPortSecure",{get:function(){if(typeof this._Client==='undefined'){return this._ProxyPortSecure;}
else{return this._Client.ProxyPortSecure;}},set:function(value){if(typeof this._Client==='undefined'){this._ProxyPortSecure=value;}
else{this._Client.ProxyPortSecure=value;}},enumerable:true,configurable:true});Object.defineProperty(fTelnet,"RLoginClientUsername",{get:function(){if(typeof this._Client==='undefined'){return this._RLoginClientUsername;}
else{return this._Client.RLoginClientUsername;}},set:function(value){if(typeof this._Client==='undefined'){this._RLoginClientUsername=value;}
else{this._Client.RLoginClientUsername=value;}},enumerable:true,configurable:true});Object.defineProperty(fTelnet,"RLoginServerUsername",{get:function(){if(typeof this._Client==='undefined'){return this._RLoginServerUsername;}
else{return this._Client.RLoginServerUsername;}},set:function(value){if(typeof this._Client==='undefined'){this._RLoginServerUsername=value;}
else{this._Client.RLoginServerUsername=value;}},enumerable:true,configurable:true});Object.defineProperty(fTelnet,"RLoginTerminalType",{get:function(){if(typeof this._Client==='undefined'){return this._RLoginTerminalType;}
else{return this._Client.RLoginTerminalType;}},set:function(value){if(typeof this._Client==='undefined'){this._RLoginTerminalType=value;}
else{this._Client.RLoginTerminalType=value;}},enumerable:true,configurable:true});Object.defineProperty(fTelnet,"ScreenColumns",{get:function(){if(typeof this._Client==='undefined'){return this._ScreenColumns;}
else{return this._Client.ScreenColumns;}},set:function(value){if(typeof this._Client==='undefined'){this._ScreenColumns=value;}
else{this._Client.ScreenColumns=value;}},enumerable:true,configurable:true});Object.defineProperty(fTelnet,"ScreenRows",{get:function(){if(typeof this._Client==='undefined'){return this._ScreenRows;}
else{return this._Client.ScreenRows;}},set:function(value){if(typeof this._Client==='undefined'){this._ScreenRows=value;}
else{this._Client.ScreenRows=value;}},enumerable:true,configurable:true});Object.defineProperty(fTelnet,"SplashScreen",{get:function(){if(typeof this._Client==='undefined'){return this._SplashScreen;}
else{return this._Client.SplashScreen;}},set:function(value){if(typeof this._Client==='undefined'){this._SplashScreen=value;}
else{this._Client.SplashScreen=value;}},enumerable:true,configurable:true});Object.defineProperty(fTelnet,"StatusBarVisible",{get:function(){if(typeof this._Client==='undefined'){return this._StatusBarVisible;}
else{return this._Client.StatusBarVisible;}},set:function(value){if(typeof this._Client==='undefined'){this._StatusBarVisible=value;}
else{this._Client.StatusBarVisible=value;}},enumerable:true,configurable:true});Object.defineProperty(fTelnet,"VirtualKeyboardVisible",{get:function(){if(typeof this._Client==='undefined'){return this._VirtualKeyboardVisible;}
else{return this._Client.VirtualKeyboardVisible;}},set:function(value){if(typeof this._Client==='undefined'){this._VirtualKeyboardVisible=value;}
else{this._Client.VirtualKeyboardVisible=value;}},enumerable:true,configurable:true});return fTelnet;}());var Rectangle=(function(){function Rectangle(x,y,width,height){this.height=0;this.width=0;this.x=0;this.y=0;if(typeof x!=='undefined'){this.x=x;}
...
var context={};var listeners=this._listeners.slice(0);for(var i=0,l=listeners.length;i<l;i++){listeners[i].apply(context,a||[]);}};return TypedEvent;}());var StringUtils=(function(){function StringUtils(){}
...
return text.substring(0,length);};StringUtils.Trim=function(text){return this.TrimLeft(this.TrimRight(text));};StringUtils.TrimLeft=function(text){return text.replace(/^\s+/g,'');};StringUtils.TrimRight=function(text){return text.replace(/\s+$/g,'');};return StringUtils;}());if(('WebSocket'in window)&&!navigator.userAgent.match('AppleWebKit/534.30')){}
...
Point.prototype.toString=function(){return'['+this.x.toString(10)+','+this.y.toString(10)+']';};return Point;}());var Ansi=(function(){function Ansi(crt){this.onesc5n=new TypedEvent();this.onesc6n=new TypedEvent();this.onesc255n=new TypedEvent();this.onescQ=new TypedEvent();this.onripdetect=new TypedEvent();this.onripdisable=new TypedEvent();this.onripenable=new TypedEvent();this.ANSI_COLORS=[0,4,2,6,1,5,3,7];this._AnsiAttr=7;this._AnsiBuffer='';this._AnsiIntermediates=[];this._AnsiParams=[];this._AnsiParserState=AnsiParserState.None;this._AnsiXY=new Point(1,1);this._Crt=crt;}
...
this._Crt.Write(Buffer);}};Ansi.prototype.WriteLn=function(text){this.Write(text+'\r\n');};return Ansi;}());var fTelnetClient=(function(){function fTelnetClient(containerId){var _this=this;this.ondata=new TypedEvent();this._HasFocus=true;this._LastTimer=0;this._UseModernScrollback=false;this._BareLFtoCRLF=false;this._BitsPerSecond=57600;this._Blink=true;this._ConnectionType='telnet';this._Emulation='ansi-bbs';this._Enter='\r';this._Font='CP437';this._ForceWss=false;this._Hostname='bbs.ftelnet.ca';this._LocalEcho=false;this._Port=1123;this._ProxyHostname='';this._ProxyPort=1123;this._ProxyPortSecure=11235;this._RLoginClientUsername='';this._RLoginServerUsername='';this._RLoginTerminalType='';this._ScreenColumns=80;this._ScreenRows=25;this._SplashScreen='';this._StatusBarVisible=true;this._VirtualKeyboardVisible=DetectMobileBrowser.IsMobile;if(typeof containerId!=='string'){var Message='fTelnet Error: fTelnet constructor was passed an invalid container id';alert(Message);throw new Error(Message);}
var Container=document.getElementById(containerId);if(Container===null){var Message='fTelnet Error: fTelnet constructor was passed an invalid container id';alert(Message);throw new Error(Message);}
...
Object.defineProperty(fTelnetClient.prototype,"BareLFtoCRLF",{get:function(){return this._BareLFtoCRLF;},set:function(value){this._BareLFtoCRLF=value;this._Crt.BareLFtoCRLF=value;},enumerable:true,configurable:true});Object.defineProperty(fTelnetClient.prototype,"BitsPerSecond",{get:function(){return this._BitsPerSecond;},set:function(value){this._BitsPerSecond=value;},enumerable:true,configurable:true});Object.defineProperty(fTelnetClient.prototype,"Blink",{get:function(){return this._Blink;},set:function(value){this._Blink=value;},enumerable:true,configurable:true});Object.defineProperty(fTelnetClient.prototype,"ButtonBarVisible",{get:function(){return true;},set:function(value){value=value;},enumerable:true,configurable:true});fTelnetClient.prototype.ClipboardCopy=function(){if(typeof this._MenuButtons!=='undefined'){this._MenuButtons.style.display='none';}
...
else if((B>=33)&&(B<=126)){this._Crt.PushKeyPress(B,0,false,false,false);}}};Object.defineProperty(fTelnetClient.prototype,"ConnectionType",{get:function(){return this._ConnectionType;},set:function(value){this._ConnectionType=value;},enumerable:true,configurable:true});fTelnetClient.prototype.Connect=function(){var _this=this;if(typeof this._MenuButtons!=='undefined'){this._MenuButtons.style.display='none';}
...
this._Connection.onclose.on(function(){_this.OnConnectionClose();});this._Connection.onconnect.on(function(){_this.OnConnectionConnect();});this._Connection.ondata.on(function(){_this.OnConnectionData();});this._Connection.onioerror.on(function(){_this.OnConnectionIOError();});this._Connection.onsecurityerror.on(function(){_this.OnConnectionSecurityError();});this._Crt.NormVideo();this._Crt.ClrScr();if(this._ProxyHostname===''){this._ConnectButton.style.display='none';this._StatusBarLabel.innerHTML='Connecting to '+this._Hostname+':'+this._Port;this._StatusBar.style.backgroundColor='blue';this._ClientContainer.style.opacity='1.0';this._Connection.connect(this._Hostname,this._Port,this._ForceWss);}
else{this._ConnectButton.style.display='none';this._StatusBarLabel.innerHTML='Connecting to '+this._Hostname+':'+this._Port+' via '+this._ProxyHostname;this._StatusBar.style.backgroundColor='blue';this._ClientContainer.style.opacity='1.0';this._Connection.connect(this._Hostname,this._Port,this._ForceWss,this._ProxyHostname,this._ProxyPort,this._ProxyPortSecure);}};Object.defineProperty(fTelnetClient.prototype,"Connected",{get:function(){if(typeof this._Connection==='undefined'){return false;}
...
this._YModemReceive.ontransfercomplete.on(function(){_this.OnDownloadComplete();});this._YModemReceive.Download();};Object.defineProperty(fTelnetClient.prototype,"Emulation",{get:function(){return this._Emulation;},set:function(value){switch(value){case'RIP':this._Emulation='RIP';this._Font='RIP_8x8';this._ScreenRows=43;break;default:this._Emulation='ansi-bbs';break;}},enumerable:true,configurable:true});Object.defineProperty(fTelnetClient.prototype,"Enter",{get:function(){return this._Enter;},set:function(value){this._Enter=value;},enumerable:true,configurable:true});fTelnetClient.prototype.EnterScrollback=function(){if(typeof this._MenuButtons!=='undefined'){this._MenuButtons.style.display='none';}
if(typeof this._ScrollbackBar!=='undefined'){if(this._ScrollbackBar.style.display='none'){this._Crt.EnterScrollback();this._ScrollbackBar.style.display='block';}}};fTelnetClient.prototype.ExitScrollback=function(){if(typeof this._ScrollbackBar!=='undefined'){if(this._ScrollbackBar.style.display='block'){this._Crt.ExitScrollback();this._ScrollbackBar.style.display='none';}}};Object.defineProperty(fTelnetClient.prototype,"Font",{get:function(){return this._Font;},set:function(value){this._Font=value;},enumerable:true,configurable:true});Object.defineProperty(fTelnetClient.prototype,"ForceWss",{get:function(){return this._ForceWss;},set:function(value){this._ForceWss=value;},enumerable:true,configurable:true});fTelnetClient.prototype.FullScreenToggle=function(){if(typeof this._MenuButtons!=='undefined'){this._MenuButtons.style.display='none';}
...
if(!this._Connection.connected){return;}
this._Connection.writeString(this._Ansi.CursorPosition(this._Crt.WindCols,this._Crt.WindRows));};fTelnetClient.prototype.OnAnsiESCQ=function(font){this._Crt.SetFont(font);};fTelnetClient.prototype.OnAnsiRIPDetect=function(){if(this._Emulation==='RIP'){if(typeof this._Connection==='undefined'){return;}
if(!this._Connection.connected){return;}
this._Connection.writeString('RIPSCRIP015400');}};fTelnetClient.prototype.OnAnsiRIPDisable=function(){};fTelnetClient.prototype.OnAnsiRIPEnable=function(){};fTelnetClient.prototype.OnConnectionClose=function(){this._ConnectButton.innerHTML='Reconnect';this._ConnectButton.style.display='inline';this._StatusBarLabel.innerHTML='Disconnected from '+this._Hostname+':'+this._Port;this._StatusBar.style.backgroundColor='red';this._ClientContainer.style.opacity='0.5';};fTelnetClient.prototype.OnConnectionConnect=function(){this._Crt.ClrScr();if(this._ProxyHostname===''){this._StatusBarLabel.innerHTML='Connected to '+this._Hostname+':'+this._Port;this._StatusBar.style.backgroundColor='blue';this._ClientContainer.style.opacity='1.0';}
...
if(typeof this._Connection==='undefined'){return;}
if(!this._Connection.connected){return;}
this._Connection.writeString(String.fromCharCode(0)+this._RLoginClientUsername+String.fromCharCode(0)+this._RLoginServerUsername+String.fromCharCode(0)+TerminalType+String.fromCharCode(0));this._Connection.flush();}};fTelnetClient.prototype.OnConnectionData=function(){var _this=this;if(typeof this._Timer!=='undefined'){if(typeof this._Connection!=='undefined'){var MSecElapsed=new Date().getTime()-this._LastTimer;if(MSecElapsed<1){MSecElapsed=1;}
var BytesToRead=Math.floor(this._BitsPerSecond/8/(1000/MSecElapsed));if(BytesToRead<1){BytesToRead=1;}
var Data=this._Connection.readString(BytesToRead);if(Data.length>0){this.ondata.trigger(Data);this._Ansi.Write(Data);}
...
this._LastTimer=new Date().getTime();};fTelnetClient.prototype.OnConnectionLocalEcho=function(value){this._LocalEcho=value;this._Crt.LocalEcho=value;};fTelnetClient.prototype.OnConnectionIOError=function(){console.log('fTelnet.OnConnectionIOError');};fTelnetClient.prototype.OnConnectionSecurityError=function(){this._ConnectButton.innerHTML='Retry Connection';this._ConnectButton.style.display='inline';if(this._ProxyHostname===''){this._StatusBarLabel.innerHTML='Unable to connect to '+this._Hostname+':'+this._Port;this._StatusBar.style.backgroundColor='red';this._ClientContainer.style.opacity='0.5';}
else{this._StatusBarLabel.innerHTML='Unable to connect to '+this._Hostname+':'+this._Port+' via '+this._ProxyHostname;this._StatusBar.style.backgroundColor='red';this._ClientContainer.style.opacity='0.5';}};fTelnetClient.prototype.OnCrtKeyPressed=function(){if(typeof this._Timer!=='undefined'){while(this._Crt.KeyPressed()){var KPE=this._Crt.ReadKey();if(typeof KPE!=='undefined'){if(KPE.keyString.length>0){if((typeof this._Connection!=='undefined')&&(this._Connection.connected)){if(KPE.keyString==='\r\n'){this._Connection.writeString(this._Enter);}
else{this._Connection.writeString(KPE.keyString);}}}}}}};fTelnetClient.prototype.OnCrtScreenSizeChanged=function(){if(this._Emulation==='RIP'){var NewWidth=640;}
else{if(this._UseModernScrollback){var NewWidth=this._Crt.ScreenCols*this._Crt.Font.Width+GetScrollbarWidth.Width;var NewHeight=this._Crt.ScreenRows*this._Crt.Font.Height;this._ClientContainer.style.width=NewWidth+'px';this._ClientContainer.style.height=NewHeight+'px';this._ClientContainer.scrollTop=this._ClientContainer.scrollHeight;}
else{var NewWidth=this._Crt.ScreenCols*this._Crt.Font.Width;}}
...
this._YModemSend.ontransfercomplete.on(function(){_this.OnUploadComplete();});if(this._UploadInput.files!==null){for(var i=0;i<this._UploadInput.files.length;i++){this.UploadFile(this._UploadInput.files[i],this._UploadInput.files.length);}}};Object.defineProperty(fTelnetClient.prototype,"Port",{get:function(){return this._Port;},set:function(value){this._Port=value;},enumerable:true,configurable:true});Object.defineProperty(fTelnetClient.prototype,"ProxyHostname",{get:function(){return this._ProxyHostname;},set:function(value){this._ProxyHostname=value;},enumerable:true,configurable:true});Object.defineProperty(fTelnetClient.prototype,"ProxyPort",{get:function(){return this._ProxyPort;},set:function(value){this._ProxyPort=value;},enumerable:true,configurable:true});Object.defineProperty(fTelnetClient.prototype,"ProxyPortSecure",{get:function(){return this._ProxyPortSecure;},set:function(value){this._ProxyPortSecure=value;},enumerable:true,configurable:true});Object.defineProperty(fTelnetClient.prototype,"RLoginClientUsername",{get:function(){return this._RLoginClientUsername;},set:function(value){this._RLoginClientUsername=value;},enumerable:true,configurable:true});Object.defineProperty(fTelnetClient.prototype,"RLoginServerUsername",{get:function(){return this._RLoginServerUsername;},set:function(value){this._RLoginServerUsername=value;},enumerable:true,configurable:true});Object.defineProperty(fTelnetClient.prototype,"RLoginTerminalType",{get:function(){return this._RLoginTerminalType;},set:function(value){this._RLoginTerminalType=value;},enumerable:true,configurable:true});Object.defineProperty(fTelnetClient.prototype,"ScreenColumns",{get:function(){return this._ScreenColumns;},set:function(value){this._ScreenColumns=value;},enumerable:true,configurable:true});Object.defineProperty(fTelnetClient.prototype,"ScreenRows",{get:function(){return this._ScreenRows;},set:function(value){this._ScreenRows=value;},enumerable:true,configurable:true});Object.defineProperty(fTelnetClient.prototype,"SplashScreen",{get:function(){return this._SplashScreen;},set:function(value){this._SplashScreen=value;},enumerable:true,configurable:true});Object.defineProperty(fTelnetClient.prototype,"StatusBarVisible",{get:function(){return this._StatusBarVisible;},set:function(value){this._StatusBarVisible=value;if(typeof this._StatusBar!=='undefined'){this._StatusBar.style.display=(value?'block':'none');}},enumerable:true,configurable:true});fTelnetClient.prototype.StuffInputBuffer=function(text){for(var i=0;i<text.length;i++){this._Crt.PushKeyPress(text.charCodeAt(i),0,false,false,false);}};fTelnetClient.prototype.Upload=function(){if(typeof this._MenuButtons!=='undefined'){this._MenuButtons.style.display='none';}
if(typeof this._Connection==='undefined'){return;}
if(!this._Connection.connected){return;}
...
FR.data.position=0;_this._YModemSend.Upload(FR,fileCount);};reader.readAsArrayBuffer(file);};Object.defineProperty(fTelnetClient.prototype,"VirtualKeyboardVisible",{get:function(){return this._VirtualKeyboardVisible;},set:function(value){if(typeof this._MenuButtons!=='undefined'){this._MenuButtons.style.display='none';}
this._VirtualKeyboardVisible=value;this._VirtualKeyboard.Visible=value;},enumerable:true,configurable:true});return fTelnetClient;}());var Offset;(function(Offset){'use strict';function getOffsetSum(elem){var top=0,left=0;while(elem){top=top+elem.offsetTop;left=left+elem.offsetLeft;elem=elem.offsetParent;}
return{y:top,x:left};}
...
this.Write(text+'\r\n');};Crt.BLACK=0;Crt.BLUE=1;Crt.GREEN=2;Crt.CYAN=3;Crt.RED=4;Crt.MAGENTA=5;Crt.BROWN=6;Crt.LIGHTGRAY=7;Crt.DARKGRAY=8;Crt.LIGHTBLUE=9;Crt.LIGHTGREEN=10;Crt.LIGHTCYAN=11;Crt.LIGHTRED=12;Crt.LIGHTMAGENTA=13;Crt.YELLOW=14;Crt.WHITE=15;Crt.BLINK=128;Crt.PETSCII_BLACK=0;Crt.PETSCII_WHITE=1;Crt.PETSCII_RED=2;Crt.PETSCII_CYAN=3;Crt.PETSCII_PURPLE=4;Crt.PETSCII_GREEN=5;Crt.PETSCII_BLUE=6;Crt.PETSCII_YELLOW=7;Crt.PETSCII_ORANGE=8;Crt.PETSCII_BROWN=9;Crt.PETSCII_LIGHTRED=10;Crt.PETSCII_DARKGRAY=11;Crt.PETSCII_GRAY=12;Crt.PETSCII_LIGHTGREEN=13;Crt.PETSCII_LIGHTBLUE=14;Crt.PETSCII_LIGHTGRAY=15;return Crt;}());var VirtualKeyboard=(function(){function VirtualKeyboard(crt,container){this._AltPressed=false;this._CapsLockEnabled=false;this._CtrlPressed=false;this._ShiftPressed=false;this._Visible=true;this._ClassKeys={'27':'Escape','36':'HomeEndInsertDelete','35':'HomeEndInsertDelete','45':'HomeEndInsertDelete','46':'HomeEndInsertDelete','8':'Backspace','9':'Tab','220':'Backslash','20':'CapsLock','13':'Enter','1004':'ShiftLeft','38':'ArrowUp','17':'Ctrl','18':'Alt','32':'Spacebar','37':'ArrowLeft','40':'ArrowDown','39':'ArrowRight'};this._Keys=[];this._Crt=crt;container.appendChild(this.CreateDivElement());var Keys=document.getElementsByClassName('fTelnetKeyboardKey');for(var i=0;i<Keys.length;i++){if(Keys[i].addEventListener){var KeyCode=Keys[i].getAttribute('data-keycode');if(KeyCode!==null){if(this._Keys[KeyCode][2]>0){Keys[i].addEventListener('click',this.OnCharCode,false);Keys[i].addEventListener('touchend',this.OnCharCode,false);Keys[i].addEventListener('touchstart',this.OnTouchStart,false);}
else{Keys[i].addEventListener('click',this.OnKeyCode,false);Keys[i].addEventListener('touchend',this.OnKeyCode,false);Keys[i].addEventListener('touchstart',this.OnTouchStart,false);}}}}}
