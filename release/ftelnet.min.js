...
var fTelnet = function () {
    function a() { } a.Init = function () {
        ...
        this._ScrollbackBar.style.display = "none"; this._Container.appendChild(this._ScrollbackBar); this._FocusWarningBar = document.createElement("div"); this._FocusWarningBar.id = "fTelnetFocusWarning"; this._FocusWarningBar.innerHTML = "*** CLICK HERE TO GIVE fTelnet FOCUS ***"; this._FocusWarningBar.style.display = "none"; this._Container.appendChild(this._FocusWarningBar); if (Crt.Init(this._Container)) {
            ...
            document.createElement("div"); this._StatusBar.id = "fTelnetStatusBar"; this._StatusBar.innerHTML = "Not connected"; this._Container.appendChild(this._StatusBar); VirtualKeyboard.Init(this._Container); this.OnCrtScreenSizeChanged(); Ansi.onesc5n.on(function () { b.OnAnsiESC5n() }); Ansi.onesc6n.on(function () { b.OnAnsiESC6n() }); Ansi.onesc255n.on(function () { b.OnAnsiESC255n() }); Ansi.onescQ.on(function (c) { b.OnAnsiESCQ(c) }); Ansi.Write(atob(this._SplashScreen))
        } else return this._InitMessageBar.innerHTML = "fTelnet Error: Unable to init Crt class",
        this._ButtonBar.style.display = "none", this._ScrollbackBar.style.display = "none", this._FocusWarningBar.style.display = "none", !1; this._Timer = setInterval(function () { b.OnTimer() }, 50); c = document.createElement("input"); c.type = "file"; c.id = "fTelnetUpload"; c.onchange = function () { b.OnUploadFileSelected() }; c.style.display = "none"; this._Container.appendChild(c); return !0
    }; Object.defineProperty(a, "BareLFtoCRLF", {
        get: function () { return this._BareLFtoCRLF }, set: function (b) { this._BareLFtoCRLF = b; Crt.BareLFtoCRLF = b }, enumerable: !0,
        configurable: !0
    }); Object.defineProperty(a, "BitsPerSecond", { get: function () { return this._BitsPerSecond }, set: function (b) { this._BitsPerSecond = b }, enumerable: !0, configurable: !0 }); Object.defineProperty(a, "Blink", { get: function () { return this._Blink }, set: function (b) { this._Blink = b }, enumerable: !0, configurable: !0 }); Object.defineProperty(a, "ConnectionType", { get: function () { return this._ConnectionType }, set: function (b) { this._ConnectionType = b }, enumerable: !0, configurable: !0 }); a.Connect = function () {
        var b = this; if (null ===
        this._Connection || !this._Connection.connected) {
            switch (this._ConnectionType) { default: this._Connection = new TelnetConnection } this._Connection.LocalEcho = this._LocalEcho; this._Connection.onclose.on(function () { b.OnConnectionClose() }); this._Connection.onconnect.on(function () { b.OnConnectionConnect() }); this._Connection.onlocalecho.on(function (c) { b.OnConnectionLocalEcho(c) }); this._Connection.onioerror.on(function () { b.OnConnectionIOError() }); this._Connection.onsecurityerror.on(function () { b.OnConnectionSecurityError() });
            Crt.NormVideo(); Crt.ClrScr(); "" === this._ProxyHostname ? (this._StatusBar.innerHTML = "Connecting to " + this._Hostname + ":" + this._Port, this._Connection.connect(this._Hostname, this._Port)) : (this._StatusBar.innerHTML = "Connecting to " + this._Hostname + ":" + this._Port + " via proxy", this._Connection.connect(this._Hostname, this._Port, this._ProxyHostname, this._ProxyPort, this._ProxyPortSecure))
        }
    }; Object.defineProperty(a, "Connected", {
        get: function () { return null === this._Connection ? !1 : this._Connection.connected }, enumerable: !0,
        configurable: !0
    }); a.Disconnect = function (b) { null !== this._Connection && this._Connection.connected && b && confirm("Are you sure you want to disconnect?") && (this._Connection.onclose.off(), this._Connection.onconnect.off(), this._Connection.onioerror.off(), this._Connection.onlocalecho.off(), this._Connection.onsecurityerror.off(), this._Connection.close(), this._Connection = null, this.OnConnectionClose()) }; a.Download = function () {
        var b = this; null !== this._Connection && this._Connection.connected && (this._YModemReceive =
        new YModemReceive(this._Connection), clearInterval(this._Timer), this._YModemReceive.ontransfercomplete.on(function () { b.OnDownloadComplete() }), this._YModemReceive.Download())
    }; Object.defineProperty(a, "Enter", { get: function () { return this._Enter }, set: function (b) { this._Enter = b }, enumerable: !0, configurable: !0 }); a.EnterScrollback = function () { this._ScrollbackBar.style.display = "none"; Crt.EnterScrollBack(); this._ScrollbackBar.style.display = "block" }; a.ExitScrollback = function () {
        this._ScrollbackBar.style.display =
        "block"; Crt.PushKeyDown(27, 27, !1, !1, !1); this._ScrollbackBar.style.display = "none"
    }; Object.defineProperty(a, "Font", { get: function () { return this._Font }, set: function (b) { this._Font = b }, enumerable: !0, configurable: !0 }); a.FullScreenToggle = function () {
        ...
        document.webkitExitFullscreen && document.webkitExitFullscreen() : this._Container.requestFullscreen ? this._Container.requestFullscreen() : this._Container.msRequestFullscreen ? this._Container.msRequestFullscreen() : this._Container.mozRequestFullScreen ? this._Container.mozRequestFullScreen() : this._Container.webkitRequestFullscreen && this._Container.webkitRequestFullscreen(Element.ALLOW_KEYBOARD_INPUT)
    }; Object.defineProperty(a, "Hostname", {
        get: function () { return this._Hostname }, set: function (b) { this._Hostname = b },
        enumerable: !0, configurable: !0
    }); Object.defineProperty(a, "LocalEcho", { get: function () { return this._LocalEcho }, set: function (b) { this._LocalEcho = b; Crt.LocalEcho = b; null !== this._Connection && this._Connection.connected && (this._Connection.LocalEcho = b) }, enumerable: !0, configurable: !0 }); a.OnAnsiESC5n = function () { this._Connection.writeString("\u001b[0n") }; a.OnAnsiESC6n = function () { this._Connection.writeString(Ansi.CursorPosition()) }; a.OnAnsiESC255n = function () {
        this._Connection.writeString(Ansi.CursorPosition(Crt.WindCols,
        Crt.WindRows))
    }; a.OnAnsiESCQ = function (b) { Crt.SetFont(b) }; a.OnConnectionClose = function () { this._StatusBar.innerHTML = "Disconnected from " + this._Hostname + ":" + this._Port }; a.OnConnectionConnect = function () { Crt.ClrScr(); this._StatusBar.innerHTML = "" === this._ProxyHostname ? "Connected to " + this._Hostname + ":" + this._Port : "Connected to " + this._Hostname + ":" + this._Port + " via proxy" }; a.OnConnectionLocalEcho = function (b) { this._LocalEcho = b; Crt.LocalEcho = b }; a.OnConnectionIOError = function () { console.log("fTelnet.OnConnectionIOError") };
    a.OnConnectionSecurityError = function () { this._StatusBar.innerHTML = "" === this._ProxyHostname ? "Unable to connect to " + this._Hostname + ":" + this._Port : "Unable to connect to " + this._Hostname + ":" + this._Port + " via proxy" }; a.OnCrtScreenSizeChanged = function () {
        var b = Crt.ScreenCols * Crt.Font.Width; null != this._FocusWarningBar && (this._FocusWarningBar.style.width = b - 10 + "px"); null != this._ButtonBar && (this._ButtonBar.style.width = b - 10 + "px"); null != this._ScrollbackBar && (this._ScrollbackBar.style.width = b - 10 + "px"); null != this._StatusBar &&
        (this._StatusBar.style.width = b - 10 + "px"); for (var c = document.getElementById("fTelnetScript").src.replace("/ftelnet.min.js", "/keyboard/keyboard-{size}.min.css"), c = c.replace("/ftelnet.debug.js", "/keyboard/keyboard-{size}.min.css"), a = [960, 800, 720, 640, 560, 480], e = 0; e < a.length; e++) if (b >= a[e] || e === a.length - 1) { document.getElementById("fTelnetKeyboardCss").href = c.replace("{size}", a[e].toString(10)); break }
    }; a.OnDownloadComplete = function () { var b = this; this._Timer = setInterval(function () { b.OnTimer() }, 50) }; a.OnTimer =
    function () {
        if (null !== this._Connection && this._Connection.connected) {
            document.hasFocus() && !this._HasFocus ? (this._HasFocus = !0, this._FocusWarningBar.style.display = "none") : !document.hasFocus() && this._HasFocus && (this._HasFocus = !1, this._FocusWarningBar.style.display = "block"); var b = (new Date).getTime() - this._LastTimer; 1 > b && (b = 1); b = Math.floor(this._BitsPerSecond / 8 / (1E3 / b)); 1 > b && (b = 1); b = this._Connection.readString(b); for (0 < b.length && Ansi.Write(b) ; Crt.KeyPressed() ;) b = Crt.ReadKey(), null !== b && 0 < b.keyString.length &&
        ...
        var b = this; if (null !== this._Connection && this._Connection.connected) {
            var c = document.getElementById("fTelnetUpload"); this._YModemSend = new YModemSend(this._Connection); clearInterval(this._Timer); this._YModemSend.ontransfercomplete.on(function () { b.OnUploadComplete() });
            for (var a = 0; a < c.files.length; a++) this.UploadFile(c.files[a], c.files.length)
        }
    }; Object.defineProperty(a, "Port", { get: function () { return this._Port }, set: function (b) { this._Port = b }, enumerable: !0, configurable: !0 }); Object.defineProperty(a, "ProxyHostname", { get: function () { return this._ProxyHostname }, set: function (b) { this._ProxyHostname = b }, enumerable: !0, configurable: !0 }); Object.defineProperty(a, "ProxyPort", { get: function () { return this._ProxyPort }, set: function (b) { this._ProxyPort = b }, enumerable: !0, configurable: !0 });
    Object.defineProperty(a, "ProxyPortSecure", { get: function () { return this._ProxyPortSecure }, set: function (b) { this._ProxyPortSecure = b }, enumerable: !0, configurable: !0 }); Object.defineProperty(a, "ScreenColumns", { get: function () { return this._ScreenColumns }, set: function (b) { this._ScreenColumns = b }, enumerable: !0, configurable: !0 }); Object.defineProperty(a, "ScreenRows", { get: function () { return this._ScreenRows }, set: function (b) { this._ScreenRows = b }, enumerable: !0, configurable: !0 }); Object.defineProperty(a, "SplashScreen",
    { get: function () { return this._SplashScreen }, set: function (b) { this._SplashScreen = b }, enumerable: !0, configurable: !0 }); a.Upload = function () { document.getElementById("fTelnetUpload").click() }; a.UploadFile = function (b, c) { var a = this, e = new FileReader; e.onload = function () { for (var f = new FileRecord(b.name, b.size), g = new Uint8Array(e.result), h = 0; h < g.length; h++) f.data.writeByte(g[h]); f.data.position = 0; a._YModemSend.Upload(f, c) }; e.readAsArrayBuffer(b) }; a._ButtonBar = null; a._Connection = null; a._Container = null; a._FocusWarningBar =
    null; a._HasFocus = !0; a._InitMessageBar = null; a._LastTimer = 0; a._ScrollbackBar = null; a._StatusBar = null; a._Timer = null; a._YModemReceive = null; a._YModemSend = null; a._BareLFtoCRLF = !1; a._BitsPerSecond = 57600; a._Blink = !0; a._ConnectionType = "telnet"; a._Enter = "\r"; a._Font = "CP437"; a._Hostname = "bbs.ftelnet.ca"; a._LocalEcho = !1; a._Port = 1123; a._ProxyHostname = ""; a._ProxyPort = 1123; a._ProxyPortSecure = 11235; a._ScreenColumns = 80; a._ScreenRows = 25; a._SplashScreen = "";
    return a
}();
(function () {
    function a(b) {
...
var TypedEvent = function () { function a() { this._listeners = [] } a.prototype.on = function (b) { this._listeners.push(b) }; a.prototype.off = function (b) { if ("function" === typeof b) for (var c = this._listeners.length; 0 < c; c++) { if (this._listeners[0] === b) { this._listeners.splice(0, 1); break } } else this._listeners = [] }; a.prototype.trigger = function () { for (var b = [], c = 0; c < arguments.length - 0; c++) b[c] = arguments[c + 0]; for (var c = {}, a = this._listeners.slice(0), e = 0, f = a.length; e < f; e++) a[e].apply(c, b || []) }; return a }(), ByteArray = function () {
    ...
    }; a.prototype.writeShort = function (b) { this.writeByte((b & 65280) >> 8); this.writeByte(b & 255) }; a.prototype.writeString = function (b) { for (var c = b.length, a = 0; a < c; a++) this.writeByte(b.charCodeAt(a)) }; return a
}(), Keyboard;
(function (a) {
    ...
    function a() { } a.AnsiCommand = function (b) {
        var c = 0, a = c = 0; switch (b) {
            case "!": 1 > this._AnsiParams.length && this._AnsiParams.push("0"); switch (parseInt(this._AnsiParams.shift(), 10)) {
                ...
                b + ")")
            } break; case "@": 1 > this._AnsiParams.length && this._AnsiParams.push("1"); c = Math.max(1, parseInt(this._AnsiParams.shift(), 10)); Crt.InsChar(c); break; case "{": console.log("Unhandled ESC sequence: Indicates that a font block is following"); break; case "A": 1 > this._AnsiParams.length && this._AnsiParams.push("1"); a = Math.max(1, parseInt(this._AnsiParams.shift(), 10)); a = Math.max(1, Crt.WhereY() - a); Crt.GotoXY(Crt.WhereX(), a); break; case "B": 1 > this._AnsiParams.length && this._AnsiParams.push("1"); a = Math.max(1, parseInt(this._AnsiParams.shift(),
            10)); a = Math.min(Crt.WindRows, Crt.WhereY() + a); Crt.GotoXY(Crt.WhereX(), a); break; case "C": 1 > this._AnsiParams.length && this._AnsiParams.push("1"); c = Math.max(1, parseInt(this._AnsiParams.shift(), 10)); c = Math.min(Crt.WindCols, Crt.WhereX() + c); Crt.GotoXY(c, Crt.WhereY()); break; case "c": 1 > this._AnsiParams.length && this._AnsiParams.push("0"); console.log("Unhandled ESC sequence: Device Attributes"); break; case "D": if (0 === this._AnsiIntermediates.length) 1 > this._AnsiParams.length && this._AnsiParams.push("1"), c = Math.max(1,
            parseInt(this._AnsiParams.shift(), 10)), c = Math.max(1, Crt.WhereX() - c), Crt.GotoXY(c, Crt.WhereY()); else if (-1 !== this._AnsiIntermediates.indexOf(" ")) { for (; 2 > this._AnsiParams.length;) this._AnsiParams.push("0"); c = parseInt(this._AnsiParams.shift(), 10); a = parseInt(this._AnsiParams.shift(), 10); 0 === c && 0 <= a && 40 >= a ? Crt.SetFont("SyncTerm-" + a.toString(10)) : console.log("Unhandled ESC sequence: Secondary Font Selection (set font " + c + " to " + a + ")"); break } break; case "E": 1 > this._AnsiParams.length && this._AnsiParams.push("1");
                a = Math.max(1, parseInt(this._AnsiParams.shift(), 10)); a = Math.min(Crt.WindRows, Crt.WhereY() + a); Crt.GotoXY(1, a); break; case "F": 1 > this._AnsiParams.length && this._AnsiParams.push("1"); a = Math.max(1, parseInt(this._AnsiParams.shift(), 10)); a = Math.max(1, Crt.WhereY() - a); Crt.GotoXY(1, a); break; case "G": 1 > this._AnsiParams.length && this._AnsiParams.push("1"); c = Math.max(1, parseInt(this._AnsiParams.shift(), 10)); 1 <= c && c <= Crt.WindCols && Crt.GotoXY(c, Crt.WhereY()); break; case "H": case "f": for (; 2 > this._AnsiParams.length;) this._AnsiParams.push("1");
                    a = Math.max(1, parseInt(this._AnsiParams.shift(), 10)); c = Math.max(1, parseInt(this._AnsiParams.shift(), 10)); Crt.GotoXY(c, a); break; case "h": 1 > this._AnsiParams.length && this._AnsiParams.push("0"); switch (this._AnsiParams[0]) {
            ...
            case "K": 1 > this._AnsiParams.length && this._AnsiParams.push("0"); switch (parseInt(this._AnsiParams.shift(), 10)) { case 0: Crt.ClrEol(); break; case 1: Crt.ClrBol(); break; case 2: Crt.ClrLine() } break; case "L": 1 > this._AnsiParams.length && this._AnsiParams.push("1"); a = Math.max(1, parseInt(this._AnsiParams.shift(), 10)); Crt.InsLine(a); break; case "l": 1 > this._AnsiParams.length && this._AnsiParams.push("0"); switch (this._AnsiParams[0]) {
            ...
            this._AnsiParams[0][0]) switch (1 > this._AnsiParams.length && this._AnsiParams.push("0"), c = parseInt(this._AnsiParams.shift(), 10), c) {
            ...
            } else 1 > this._AnsiParams.length && this._AnsiParams.push("1"), a = Math.max(1, parseInt(this._AnsiParams.shift(), 10)), Crt.DelLine(a); break; case "m": for (1 > this._AnsiParams.length && this._AnsiParams.push("0") ; 0 < this._AnsiParams.length;) switch (c = parseInt(this._AnsiParams.shift(), 10), c) {
                case 0: Crt.NormVideo(); break; case 1: Crt.HighVideo(); break; case 2: Crt.LowVideo(); break; case 5: Crt.SetBlink(!0); Crt.SetBlinkRate(500); break; case 6: Crt.SetBlink(!0);
                    Crt.SetBlinkRate(250); break; case 7: Crt.ReverseVideo(); break; case 8: this._AnsiAttr = Crt.TextAttr; Crt.Conceal(); break; case 22: Crt.LowVideo(); break; case 25: Crt.SetBlink(!1); break; case 27: Crt.ReverseVideo(); break; case 28: Crt.TextAttr = this._AnsiAttr; break; case 30: case 31: case 32: case 33: case 34: case 35: case 36: case 37: c = this.ANSI_COLORS[c - 30]; 7 < Crt.TextAttr % 16 && (c += 8); Crt.TextColor(c); break; case 39: c = this.ANSI_COLORS[7]; 7 < Crt.TextAttr % 16 && (c += 8); Crt.TextColor(c); break; case 40: case 41: case 42: case 43: case 44: case 45: case 46: case 47: c =
                    this.ANSI_COLORS[c - 40]; Crt.TextBackground(c); break; case 49: c = this.ANSI_COLORS[0], Crt.TextBackground(c)
            } break; case "N": console.log("Unhandled ESC sequence: ANSI Music"); break; case "n": 1 > this._AnsiParams.length && this._AnsiParams.push("0"); c = parseInt(this._AnsiParams.shift(), 10); switch (c) {
                ...
                ") FB(" + b + ")")
            } break; case "P": 1 > this._AnsiParams.length && this._AnsiParams.push("1"); c = Math.max(1, parseInt(this._AnsiParams.shift(), 10)); Crt.DelChar(c); break; case "Q": for (; 3 > this._AnsiParams.length;) this._AnsiParams.push("0"); c = parseInt(this._AnsiParams.shift(), 10); parseInt(this._AnsiParams.shift(), 10); parseInt(this._AnsiParams.shift(), 10); this.onescQ.trigger(c.toString(10)); break; case "r": 0 === this._AnsiIntermediates.length ? console.log("Unknown ESC sequence: PB(" + this._AnsiParams.toString() + ") IB(" +
            this._AnsiIntermediates.toString() + ") FB(" + b + ")") : -1 !== this._AnsiIntermediates[0].indexOf("*") ? console.log("Unhandled ESC sequence: Set the output emulation speed.") : -1 !== this._AnsiIntermediates[0].indexOf("]") ? console.log("Unhandled ESC sequence: Set Top and Bottom Margins") : console.log("Unknown ESC sequence: PB(" + this._AnsiParams.toString() + ") IB(" + this._AnsiIntermediates.toString() + ") FB(" + b + ")"); break; case "S": 1 > this._AnsiParams.length && this._AnsiParams.push("1"); a = Math.max(1, parseInt(this._AnsiParams.shift(),
            10)); Crt.ScrollUpScreen(a); break; case "s": 0 === this._AnsiIntermediates.length ? this._AnsiXY = new Point(Crt.WhereX(), Crt.WhereY()) : console.log("Unhandled ESC sequence: Save Mode Setting"); break; case "T": 1 > this._AnsiParams.length && this._AnsiParams.push("1"); a = Math.max(1, parseInt(this._AnsiParams.shift(), 10)); Crt.ScrollDownWindow(a); break; case "U": console.log("Unhandled ESC sequence: Clear screen with default attribute"); break; case "u": 0 === this._AnsiIntermediates.length ? Crt.GotoXY(this._AnsiXY.x, this._AnsiXY.y) :
            console.log("Unhandled ESC sequence: Restore Mode Setting"); break; case "X": 1 > this._AnsiParams.length && this._AnsiParams.push("1"); c = Math.max(1, parseInt(this._AnsiParams.shift(), 10)); Crt.DelChar(c); break; case "Z": console.log("Unhandled ESC sequnce: Cursor Backward Tabulation"); break; default: console.log("Unknown ESC sequence: PB(" + this._AnsiParams.toString() + ") IB(" + this._AnsiIntermediates.toString() + ") FB(" + b + ")")
        }
...
TelnetConnection = function (a) {
    ...
    function a() { } a.Init = function (a) {
        ...
        } this._Div = document.createElement("div"); this._Div.id = "fTelnetKeyboard"; this._Div.innerHTML = c; return this._Div
        ...
        a = parseInt(a.target.getAttribute("data-keycode"), 10);
        var c = 0, c = 65 <= a && 90 >= a ? parseInt(this._ShiftPressed !== this._CapsLockEnabled ? this._Keys[a][2] : this._Keys[a][3], 10) : parseInt(this._ShiftPressed ? this._Keys[a][2] : this._Keys[a][3], 10), d = !1, e = !0; this._AltPressed && (d = !0, e = !1); this._CtrlPressed && (d = !0, e = !1); this._ShiftPressed && (d = !0); Crt.PushKeyDown(0, a, this._CtrlPressed, this._AltPressed, this._ShiftPressed); e && Crt.PushKeyPress(c, 0, this._CtrlPressed, this._AltPressed, this._ShiftPressed); d && (this._ShiftPressed = this._CtrlPressed = this._AltPressed = !1, this.ReDrawSpecialKeys())
    };
    a.OnKeyCode = function (a) {
        a = parseInt(a.target.getAttribute("data-keycode"), 10); var c = !1; switch (a) { case 18: this._AltPressed = !this._AltPressed; this.ReDrawSpecialKeys(); break; case 20: this._CapsLockEnabled = !this._CapsLockEnabled; this.ReDrawSpecialKeys(); break; case 17: this._CtrlPressed = !this._CtrlPressed; this.ReDrawSpecialKeys(); break; case 1004: case 1005: this._ShiftPressed = !this._ShiftPressed; this.ReDrawSpecialKeys(); break; default: c = !0 } Crt.PushKeyDown(0, a, this._CtrlPressed, this._AltPressed, this._ShiftPressed);
        c && (this._ShiftPressed = this._CtrlPressed = this._AltPressed = !1, this.ReDrawSpecialKeys())
    }; a.ReDrawSpecialKeys = function () { this.HighlightKey("fTelnetKeyboardKeyCapsLock", this._CapsLockEnabled); this.HighlightKey("fTelnetKeyboardKeyShiftLeft", this._ShiftPressed); this.HighlightKey("fTelnetKeyboardKeyShiftRight", this._ShiftPressed); this.HighlightKey("fTelnetKeyboardKeyCtrl", this._CtrlPressed); this.HighlightKey("fTelnetKeyboardKeyAlt", this._AltPressed) }; a._Div = null; a._AltPressed = !1; a._CapsLockEnabled = !1; a._CtrlPressed =
    !1; a._ShiftPressed = !1; a._ClassKeys = { 27: "Escape", 145: "SPID", 1006: "SPID", 45: "SPID", 46: "SPID", 8: "Backspace", 9: "Tab", 220: "Backslash", 20: "CapsLock", 13: "Enter", 1004: "ShiftLeft", 1005: "ShiftRight", 38: "ArrowUp", 17: "Ctrl", 91: "Win", 18: "Alt", 32: "Spacebar", 93: "AppMenu", 37: "ArrowLeft", 40: "ArrowDown", 39: "ArrowRight" }; a._Keys = []; return a
}(), CRC = function () {
    function a() { } a.Calculate16 = function (a) {
        var c = 0, d = a.position; for (a.position = 0; 0 < a.bytesAvailable;) c = this.UpdateCrc(a.readUnsignedByte(), c); c = this.UpdateCrc(0, c);
        c = this.UpdateCrc(0, c); a.position = d; return c
    }; a.UpdateCrc = function (a, c) { return (this.CRC_TABLE[c >> 8 & 255] ^ c << 8 ^ a) & 65535 }; a.CRC_TABLE = [0, 4129, 8258, 12387, 16516, 20645, 24774, 28903, 33032, 37161, 41290, 45419, 49548, 53677, 57806, 61935, 4657, 528, 12915, 8786, 21173, 17044, 29431, 25302, 37689, 33560, 45947, 41818, 54205, 50076, 62463, 58334, 9314, 13379, 1056, 5121, 25830, 29895, 17572, 21637, 42346, 46411, 34088, 38153, 58862, 62927, 50604, 54669, 13907, 9842, 5649, 1584, 30423, 26358, 22165, 18100, 46939, 42874, 38681, 34616, 63455, 59390, 55197, 51132, 18628,
    22757, 26758, 30887, 2112, 6241, 10242, 14371, 51660, 55789, 59790, 63919, 35144, 39273, 43274, 47403, 23285, 19156, 31415, 27286, 6769, 2640, 14899, 10770, 56317, 52188, 64447, 60318, 39801, 35672, 47931, 43802, 27814, 31879, 19684, 23749, 11298, 15363, 3168, 7233, 60846, 64911, 52716, 56781, 44330, 48395, 36200, 40265, 32407, 28342, 24277, 20212, 15891, 11826, 7761, 3696, 65439, 61374, 57309, 53244, 48923, 44858, 40793, 36728, 37256, 33193, 45514, 41451, 53516, 49453, 61774, 57711, 4224, 161, 12482, 8419, 20484, 16421, 28742, 24679, 33721, 37784, 41979, 46042, 49981, 54044, 58239,
    62302, 689, 4752, 8947, 13010, 16949, 21012, 25207, 29270, 46570, 42443, 38312, 34185, 62830, 58703, 54572, 50445, 13538, 9411, 5280, 1153, 29798, 25671, 21540, 17413, 42971, 47098, 34713, 38840, 59231, 63358, 50973, 55100, 9939, 14066, 1681, 5808, 26199, 30326, 17941, 22068, 55628, 51565, 63758, 59695, 39368, 35305, 47498, 43435, 22596, 18533, 30726, 26663, 6336, 2273, 14466, 10403, 52093, 56156, 60223, 64286, 35833, 39896, 43963, 48026, 19061, 23124, 27191, 31254, 2801, 6864, 10931, 14994, 64814, 60687, 56684, 52557, 48554, 44427, 40424, 36297, 31782, 27655, 23652, 19525, 15522,
    11395, 7392, 3265, 61215, 65342, 53085, 57212, 44955, 49082, 36825, 40952, 28183, 32310, 20053, 24180, 11923, 16050, 3793, 7920]; return a
}(), FileRecord = function () {
    function a(a, c) { this._Data = new ByteArray; this._Name = ""; this._Size = 0; this._Name = a; this._Size = c } Object.defineProperty(a.prototype, "data", { get: function () { return this._Data }, enumerable: !0, configurable: !0 }); Object.defineProperty(a.prototype, "name", { get: function () { return this._Name }, enumerable: !0, configurable: !0 }); Object.defineProperty(a.prototype, "size", {
        get: function () { return this._Size },
        enumerable: !0, configurable: !0
    }); return a
}(), YModemReceive = function () {
    function a(a) {
        var c = this; this.ontransfercomplete = new TypedEvent; this.SOH = 1; this.STX = 2; this.EOT = 4; this.ACK = 6; this.CAN = 24; this.CAPG = 71; this._Blink = !1; this._ExpectingHeader = !0; this._Files = []; this._NextByte = this._LastGTime = 0; this._ShouldSendG = !0; this._TotalBytesReceived = 0; this.OnCrtCanvasClick = function (a) {
            "ontouchend" in document && a.target.removeEventListener("touchend", c.OnCrtCanvasClick); a.target.removeEventListener("click", c.OnCrtCanvasClick);
            for (a = 0; a < c._Files.length; a++) try { c.SaveFile(a) } catch (b) { console.log("Error saving file #" + a.toString(10)) } c.Dispatch()
        }; this._Connection = a
    } a.prototype.Cancel = function (a) {
        try { this._Connection.writeByte(this.CAN), this._Connection.writeByte(this.CAN), this._Connection.writeByte(this.CAN), this._Connection.writeByte(this.CAN), this._Connection.writeByte(this.CAN), this._Connection.writeString("\b\b\b\b\b     \b\b\b\b\b") } catch (c) { this.HandleIOError(c); return } try { this._Connection.readString() } catch (d) {
            this.HandleIOError(d);
            return
        } this.CleanUp("Cancelling (" + a + ")")
    }; a.prototype.CleanUp = function (a) {
        var c = this; clearInterval(this._Timer); this.lblStatus.Text = "Status: " + a; 0 < this._Files.length ? (this.lblStatus.Height = 2, this.lblStatus.Text += "\r\n*** CLICK/TOUCH HERE TO DOWNLOAD YOUR FILE", 1 < this._Files.length && (this.lblStatus.Text += "S"), this.lblStatus.Text += " ***", "ontouchend" in document && Crt.Canvas.addEventListener("touchend", this.OnCrtCanvasClick), Crt.Canvas.addEventListener("click", this.OnCrtCanvasClick)) : setTimeout(function () { c.Dispatch() },
        3E3)
    }; a.prototype.Dispatch = function () { this.pnlMain.Hide(); Crt.Blink = this._Blink; Crt.ShowCursor(); this.ontransfercomplete.trigger() }; a.prototype.Download = function () {
        var a = this; this._Timer = setInterval(function () { a.OnTimer() }, 50); this._Blink = Crt.Blink; Crt.Blink = !1; Crt.HideCursor(); this.pnlMain = new CrtPanel(null, 10, 5, 60, 14, 0, Crt.WHITE, Crt.BLUE, "YModem-G Receive Status (Hit CTRL+X to abort)", 6); this.lblFileCount = new CrtLabel(this.pnlMain, 2, 2, 56, "Receiving file 1", 9, Crt.YELLOW, Crt.BLUE); this.lblFileName =
        new CrtLabel(this.pnlMain, 2, 4, 56, "File Name: ", 9, Crt.YELLOW, Crt.BLUE); this.lblFileSize = new CrtLabel(this.pnlMain, 2, 5, 56, "File Size: ", 9, Crt.YELLOW, Crt.BLUE); this.lblFileReceived = new CrtLabel(this.pnlMain, 2, 6, 56, "File Recv: ", 9, Crt.YELLOW, Crt.BLUE); this.pbFileReceived = new CrtProgressBar(this.pnlMain, 2, 7, 56, 219); this.lblTotalReceived = new CrtLabel(this.pnlMain, 2, 9, 56, "Total Recv: ", 9, Crt.YELLOW, Crt.BLUE); this.lblStatus = new CrtLabel(this.pnlMain, 2, 11, 56, "Status: Transferring file(s)", 9, Crt.WHITE, Crt.BLUE)
    };
    a.prototype.FileAt = function (a) { return this._Files[a] }; Object.defineProperty(a.prototype, "FileCount", { get: function () { return this._Files.length }, enumerable: !0, configurable: !0 }); a.prototype.HandleIOError = function (a) { console.log("I/O Error: " + a); this._Connection.connected ? this.CleanUp("Unhandled I/O error") : this.CleanUp("Connection to server lost") }; a.prototype.OnTimer = function () {
        for (; Crt.KeyPressed() ;) { var a = Crt.ReadKey(); null !== a && 0 < a.keyString.length && a.keyString.charCodeAt(0) === this.CAN && this.Cancel("User requested abort") } for (; ;) {
            if (0 ===
            this._NextByte) if (0 === this._Connection.bytesAvailable) { if (this._ShouldSendG && 3E3 < (new Date).getTime() - this._LastGTime) { try { this._Connection.writeByte(this.CAPG), this._Connection.flush() } catch (c) { this.HandleIOError(c); break } this._LastGTime = (new Date).getTime() } break } else try { this._NextByte = this._Connection.readUnsignedByte() } catch (d) { this.HandleIOError(d); break } switch (this._NextByte) {
                case this.CAN: this.CleanUp("Sender requested abort"); break; case this.SOH: case this.STX: this._ShouldSendG = !1; var e = this._NextByte ===
                this.STX ? 1024 : 128; if (this._Connection.bytesAvailable < 2 + e + 1 + 1) return; this._NextByte = 0; var f = this._Connection.readUnsignedByte(), a = this._Connection.readUnsignedByte(); if (a !== 255 - f) { this.Cancel("Bad block #: " + a.toString() + " !== 255-" + f.toString()); return } a = new ByteArray; this._Connection.readBytes(a, 0, e); var g = this._Connection.readUnsignedShort(), h = CRC.Calculate16(a); if (g !== h) { this.Cancel("Bad CRC: " + g.toString() + " !== " + h.toString()); return } if (this._ExpectingHeader) {
                    if (0 !== f) {
                        this.Cancel("Expecting header got block " +
                        f.toString()); return
                    } this._ExpectingHeader = !1; e = ""; for (g = a.readUnsignedByte() ; 0 !== g && 0 < a.bytesAvailable;) e += String.fromCharCode(g), g = a.readUnsignedByte(); f = ""; g = 0; for (g = a.readUnsignedByte() ; 48 <= g && 57 >= g && 0 < a.bytesAvailable;) f += String.fromCharCode(g), g = a.readUnsignedByte(); g = parseInt(f, 10); if (0 === e.length) { this.CleanUp("File(s) successfully received!"); return } if (isNaN(g) || 0 === g) { this.Cancel("File Size missing from header block"); return } this._File = new FileRecord(e, g); this.lblFileCount.Text = "Receiving file " +
                    (this._Files.length + 1).toString(); this.lblFileName.Text = "File Name: " + e; this.lblFileSize.Text = "File Size: " + StringUtils.AddCommas(g) + " bytes"; this.lblFileReceived.Text = "File Recv: 0 bytes"; this.pbFileReceived.Value = 0; this.pbFileReceived.Maximum = g; try { this._Connection.writeByte(this.CAPG), this._Connection.flush() } catch (k) { this.HandleIOError(k); return }
                } else e = Math.min(e, this._File.size - this._File.data.length), this._File.data.writeBytes(a, 0, e), this._TotalBytesReceived += e, this.lblFileReceived.Text = "File Recv: " +
                StringUtils.AddCommas(this._File.data.length) + " bytes", this.pbFileReceived.Value = this._File.data.length, this.lblTotalReceived.Text = "Total Recv: " + StringUtils.AddCommas(this._TotalBytesReceived) + " bytes"; break; case this.EOT: this._ShouldSendG = !0; try { this._Connection.writeByte(this.ACK), this._Connection.writeByte(this.CAPG), this._Connection.flush() } catch (l) { this.HandleIOError(l); return } this._NextByte = 0; this._ExpectingHeader = !0; this._Files.push(this._File); break; default: this.Cancel("Unexpected byte: " +
                this._NextByte.toString()); return
            }
        }
    ...
    function a(a) {
        this.ontransfercomplete = new TypedEvent; this.SOH = 1; this.STX = 2; this.EOT = 4; this.ACK = 6; this.NAK = 21; this.CAN = 24; this.SUB = 26; this.CAPG = 71; this._Block = 0; this._Blink = !1; this._FileCount =
        this._FileBytesSent = this._EOTCount = 0; this._Files = []; this._TotalBytesSent = this._TotalBytes = this._State = 0; this._Connection = a
    } a.prototype.Cancel = function (a) {
        try { this._Connection.writeByte(this.CAN), this._Connection.writeByte(this.CAN), this._Connection.writeByte(this.CAN), this._Connection.writeByte(this.CAN), this._Connection.writeByte(this.CAN), this._Connection.writeString("\b\b\b\b\b     \b\b\b\b\b") } catch (c) { this.HandleIOError(c); return } try { this._Connection.readString() } catch (d) {
            this.HandleIOError(d);
            return
        } this.CleanUp("Cancelling (" + a + ")")
    }; a.prototype.CleanUp = function (a) { var c = this; clearInterval(this._Timer); this.lblStatus.Text = "Status: " + a; setTimeout(function () { c.Dispatch() }, 3E3) }; a.prototype.Dispatch = function () { this.pnlMain.Hide(); Crt.Blink = this._Blink; Crt.ShowCursor(); this.ontransfercomplete.trigger() }; a.prototype.HandleIOError = function (a) { console.log("I/O Error: " + a); this._Connection.connected ? this.CleanUp("Unhandled I/O error") : this.CleanUp("Connection to server lost") }; a.prototype.OnTimer =
    function () {
        for (; Crt.KeyPressed() ;) { var a = Crt.ReadKey(); null !== a && 0 < a.keyString.length && a.keyString.charCodeAt(0) === this.CAN && this.Cancel("User requested abort") } if (3 === this._State || 0 !== this._Connection.bytesAvailable) switch (a = 0, this._State) {
            case 0: try { a = this._Connection.readUnsignedByte() } catch (c) { this.HandleIOError(c); break } if (a !== this.CAPG) { this.Cancel("Expecting G got " + a.toString() + " (State=" + this._State + ")"); break } try { this._Connection.readString() } catch (d) { this.HandleIOError(d); break } if (0 ===
            this._Files.length) { this.SendEmptyHeaderBlock(); this.CleanUp("File(s) successfully sent!"); break } this._File = this._Files.shift(); this.lblFileCount.Text = "Sending file " + (this._FileCount - this._Files.length).toString() + " of " + this._FileCount.toString(); this.lblFileName.Text = "File Name: " + this._File.name; this.lblFileSize.Text = "File Size: " + StringUtils.AddCommas(this._File.size) + " bytes"; this.lblFileSent.Text = "File Sent: 0 bytes"; this.pbFileSent.Value = 0; this.pbFileSent.Maximum = this._File.size; this.SendHeaderBlock();
                this._Block = 1; this._FileBytesSent = this._EOTCount = 0; this._State = 1; break; case 1: try { a = this._Connection.readUnsignedByte() } catch (e) { this.HandleIOError(e); break } if (a !== this.ACK && a !== this.CAPG) { this.Cancel("Expecting ACK/G got " + a.toString() + " (State=" + this._State + ")"); break } a === this.ACK ? this._State = 2 : a === this.CAPG && (this._State = 3); break; case 2: try { a = this._Connection.readUnsignedByte() } catch (f) { this.HandleIOError(f); break } if (a !== this.CAPG) {
                    this.Cancel("Expecting G got " + a.toString() + " (State=" + this._State +
                    ")"); break
        ...
        for (var c = 0; c < a; c++) {
            var d = Math.min(1024, this._File.data.bytesAvailable); if (0 === d) return this.SendEOT(), !0; var e = new ByteArray;
            this._File.data.readBytes(e, 0, d); if (1024 > e.length) { for (e.position = e.length; 1024 > e.length;) e.writeByte(this.SUB); e.position = 0 } try { this._Connection.writeByte(this.STX), this._Connection.writeByte(this._Block % 256), this._Connection.writeByte(255 - this._Block % 256), this._Connection.writeBytes(e), this._Connection.writeShort(CRC.Calculate16(e)), this._Connection.flush() } catch (f) { this.HandleIOError(f); break } this._Block++; this._FileBytesSent += d; this._TotalBytesSent += d; this.lblFileSent.Text = "File Sent: " + StringUtils.AddCommas(this._FileBytesSent) +
            " bytes"; this.pbFileSent.StepBy(d); this.lblTotalSent.Text = "Total Sent: " + StringUtils.AddCommas(this._TotalBytesSent) + " bytes"; this.pbTotalSent.StepBy(d)
        } return !1
    }; a.prototype.SendEmptyHeaderBlock = function () { for (var a = new ByteArray, c = 0; 128 > c; c++) a.writeByte(0); try { this._Connection.writeByte(this.SOH), this._Connection.writeByte(0), this._Connection.writeByte(255), this._Connection.writeBytes(a), this._Connection.writeShort(CRC.Calculate16(a)), this._Connection.flush() } catch (d) { this.HandleIOError(d) } }; a.prototype.SendEOT =
    function () { try { this._Connection.writeByte(this.EOT), this._Connection.flush() } catch (a) { this.HandleIOError(a); return } this._EOTCount++ }; a.prototype.SendHeaderBlock = function () {
