...
this._CanvasContext.fillStyle=this._Cursor.Colour;this._CanvasContext.fillRect((this.WhereXA()-1)*this._Font.Size.x,(this.WhereYA()*this._Font.Size.y)-(this._Font.Size.y*0.20),this._Font.Size.x,this._Font.Size.y*0.20);this._Cursor.LastPosition=new Point(this.WhereXA(),this.WhereYA());};Crt.prototype.OnBlinkShow=function(){if(this._BlinkHidden){this._BlinkHidden=false;for(var Y=1;Y<=this._ScreenSize.y;Y++){for(var X=1;X<=this._ScreenSize.x;X++){if(this._Buffer[Y][X].Blink){if(this._Buffer[Y][X].Ch!==' '){this.FastWrite(this._Buffer[Y][X].Ch,X,Y,this._Buffer[Y][X],false);}}}}}
var X=this._Cursor.LastPosition.x;var Y=this._Cursor.LastPosition.y;var Cell=this._Buffer[Y][X];this.FastWrite(Cell.Ch,X,Y,Cell,false);};Crt.prototype.OnFontChanged=function(){this._Cursor.Size=this._Font.Size;this._Canvas.width=this._Font.Width*this._ScreenSize.x;if(this._UseModernScrollback){this._Canvas.height=this._Font.Height*(this._ScreenSize.y+this._ScrollbackSize);this._CanvasContext.fillRect(0,0,this._Canvas.width,this._Canvas.height);}
else{this._Canvas.height=this._Font.Height*this._ScreenSize.y;}
this._TempCanvas.width=this._Canvas.width;this._TempCanvas.height=this._Canvas.height;if(typeof this._Buffer!=='undefined'){for(var Y=1;Y<=this._ScreenSize.y;Y++){for(var X=1;X<=this._ScreenSize.x;X++){this.FastWrite(this._Buffer[Y][X].Ch,X,Y,this._Buffer[Y][X],false);}}}
...
BScrollUp.Stop();this._CanvasContext.fillStyle='#'+StringUtils.PadLeft(CrtFont.ANSI_COLOURS[(charInfo.Attr&0xF0)>>4].toString(16),'0',6);Left=(left-1)*this._Font.Width;Top=(bottom-count)*this._Font.Height;Width=(right-left+1)*this._Font.Width;Height=(count*this._Font.Height);this._CanvasContext.fillRect(Left,Top,Width,Height);}
...
this._Crt.PushKeyDown(0,KeyCode,this._CtrlPressed,this._AltPressed,this._ShiftPressed);if(!!navigator.vibrate){navigator.vibrate(100);}
