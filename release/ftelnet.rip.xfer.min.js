...
var WebSocketConnection=(function(){function WebSocketConnection(){this.onclose=new TypedEvent();this.onconnect=new TypedEvent();this.ondata=new TypedEvent();this.onlocalecho=new TypedEvent();this.onioerror=new TypedEvent();this.onsecurityerror=new TypedEvent();this._WasConnected=false;this._LocalEcho=false;this._Protocol='plain';this._Proxied=false;this._InputBuffer=new ByteArray();this._OutputBuffer=new ByteArray();}
Object.defineProperty(WebSocketConnection.prototype,"bytesAvailable",{get:function(){return this._InputBuffer.bytesAvailable;},enumerable:true,configurable:true});WebSocketConnection.prototype.close=function(){if(window.cordova){if(this._CordovaSocket){this._CordovaSocket.close();}}
...
this._WasConnected=false;if(window.cordova){this._Proxied=false;this._CordovaSocket=new Socket();this._CordovaSocket.open(hostname,port,function(){_this.OnSocketOpen();},function(message){var e=new ErrorEvent();e.initErrorEvent('Socket',true,false,message,'',-1);_this.OnSocketError(e);});this._CordovaSocket.onClose=function(){_this.OnSocketClose();};this._CordovaSocket.onData=function(data){_this.OnCordovaSocketData(data);};this._CordovaSocket.onError=function(message){var e=new ErrorEvent();e.initErrorEvent('Socket',true,false,message,'',-1);_this.OnSocketError(e);};}
