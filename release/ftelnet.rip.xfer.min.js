...
if(updateBuffer){var CharToUpdate=this._Buffer[y][x+i];CharToUpdate.Ch=Chars[i];CharToUpdate.Attr=charInfo.Attr;CharToUpdate.Blink=charInfo.Blink;CharToUpdate.Underline=charInfo.Underline;CharToUpdate.Reverse=charInfo.Reverse;}
...
var CharMapKey=charCode+'-'+charInfo.Attr+'-'+charInfo.Reverse;if(!this._CharMap[CharMapKey]){var NewChar=this._CanvasContext.getImageData(charCode*this._Size.x,0,this._Size.x,this._Size.y);var Back;var Fore;if(this._Name.indexOf('C64')===0){Back=CrtFont.PETSCII_COLOURS[(charInfo.Attr&0xF0)>>4];Fore=CrtFont.PETSCII_COLOURS[(charInfo.Attr&0x0F)];}
...
return this._Connection.connected;},enumerable:true,configurable:true});Object.defineProperty(fTelnetClient.prototype,"Crt",{get:function(){return this._Crt;},enumerable:true,configurable:true});fTelnetClient.prototype.Disconnect=function(prompt){if(typeof this._MenuButtons!=='undefined'){this._MenuButtons.style.display='none';}
