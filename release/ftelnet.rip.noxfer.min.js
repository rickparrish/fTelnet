...
break;case'I':x=Math.max(1,this.GetNextParam(1));this._Crt.Write(StringUtils.NewString('\t',x));break;case'J':switch(this.GetNextParam(0)){case 0:this._Crt.ClrEos();break;case 1:this._Crt.ClrBos();break;case 2:this._Crt.ClrScr();break;case 3:this._Crt.ClrScr();break;}
...
else if(text.charAt(i)===']'){this._Crt.Write(Buffer);Buffer='';console.log('Unhandled ESC sequence: Operating System Command');this._AnsiParserState=AnsiParserState.None;}
else if(text.charAt(i)==='^'){this._Crt.Write(Buffer);Buffer='';console.log('Unhandled ESC sequence: Privacy Message');this._AnsiParserState=AnsiParserState.None;}
else if(text.charAt(i)==='_'){this._Crt.Write(Buffer);Buffer='';console.log('Unhandled ESC sequence: Application Program String');this._AnsiParserState=AnsiParserState.None;}
...
else if(text.charAt(i)==='P'){this._Crt.Write(Buffer);Buffer='';console.log('Unhandled ESC sequence: Device Control String');this._AnsiParserState=AnsiParserState.None;}
else if(text.charAt(i)==='X'){this._Crt.Write(Buffer);Buffer='';console.log('Unhandled ESC sequence: Start Of String');this._AnsiParserState=AnsiParserState.None;}
