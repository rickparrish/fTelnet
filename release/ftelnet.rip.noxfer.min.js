...
return KPE;}};Object.defineProperty(Crt.prototype,"ReportMouse",{get:function(){return this._ReportMouse;},set:function(value){this._ReportMouse=value;},enumerable:true,configurable:true});Object.defineProperty(Crt.prototype,"ReportMouseSgr",{get:function(){return this._ReportMouseSgr;},set:function(value){this._ReportMouseSgr=value;},enumerable:true,configurable:true});Crt.prototype.ResetBenchmarks=function(){Benchmarks.Reset();};Crt.prototype.RestoreScreen=function(buffer,left,top,right,bottom){var Height=bottom-top+1;var Width=right-left+1;for(var Y=0;Y<Height;Y++){for(var X=0;X<Width;X++){this.FastWrite(buffer[Y][X].Ch,X+left,Y+top,buffer[Y][X]);}}};Crt.prototype.ReverseVideo=function(){this.TextAttr=((this.TextAttr&0xF0)>>4)|((this.TextAttr&0x0F)<<4);};Crt.prototype.SaveScreen=function(left,top,right,bottom){var Height=bottom-top+1;var Width=right-left+1;var Result=[];for(var Y=0;Y<Height;Y++){Result[Y]=[];for(var X=0;X<Width;X++){Result[Y][X]=new CharInfo(this._Buffer[Y+top][X+left]);}}
